...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 363.0, 67.0, 40.0 ],
					"text" : "Solo note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 551.0, 157.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 97.0, 169.0, 54.0 ],
					"text" : "Defining solo elements is only possible if \"allowsolo\" is 1 (default)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 530.0, 98.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 530.0, 123.0, 83.0, 19.0 ],
					"text" : "allowsolo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 182.0, 341.0, 40.0 ],
					"text" : "Solo elements appear by default in a yellowish color. You can change the solo color in the object inspector"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 192.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 308.0, 365.0, 196.0, 40.0 ],
					"text" : "Solo voice (hence all its chords)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.5, 257.0, 75.0, 40.0 ],
					"text" : "Solo chord"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 168.0, 350.0, 158.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "To remove all solo elements, you can use the popup menu (see #popup+menu): for instance, right-click (or two-finger tap) on the background of the object, and choose: \"No Solos\"",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.5, 224.0, 110.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 151.0, 343.0, 25.0 ],
					"text" : "Remove the solo flag to the currently selected content"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 122.0, 274.0, 25.0 ],
					"text" : "Set the currently selected content as solo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 154.0, 49.0, 19.0 ],
					"text" : "unsolo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 125.0, 34.0, 19.0 ],
					"text" : "solo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 101.0, 313.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 593.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each notation items can be set as solo. When solo elements are defined, they are the only one considered at playtime: when any other element is reached by the playhead, its content is simply not output. If solo elements are defined, they are also the only one accounted for by the offline play system (selection dump): if you select any other element and press V, nothing is output.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, solo, unsolo, soloed, message",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 539.5, 253.0, 15.5, 253.0 ],
					"source" : [ "obj-21", 0 ]
				}
