...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.5, 384.0, 183.5, 69.0 ],
					"presentation_rect" : [ 258.0, 381.0, 0.0, 0.0 ],
					"text" : "Or you can simply use bach.quantize in separate mode as a sort of specialized \"calculator\"!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.5, 451.0, 109.0, 21.0 ],
					"text" : "bach.print Boxed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 9.0, 425.0, 224.0, 21.0 ],
					"text" : "bach.quantize separate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 9.0, 396.0, 65.0, 19.0 ],
					"presentation_rect" : [ 160.0, 413.0, 0.0, 0.0 ],
					"text" : "(2 4) (60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 77.333328, 365.0, 173.0, 19.0 ],
					"presentation_rect" : [ 230.0, 413.0, 0.0, 0.0 ],
					"text" : "(300 300 400 -200 320 320)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.0, 238.0, 159.0, 98.0 ],
					"text" : "When a new score is output by bach quantize,\nYou can also choose whether to autoclear the score (default) or not"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 505.0, 339.0, 78.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 341.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 366.0, 86.0, 19.0 ],
					"text" : "autoclear $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 461.0, 236.0, 99.0, 21.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 384.0, 84.0, 212.0, 50.0 ],
					"text" : "It works as well with more than one voice. Just give the list of voices as in beatbox syntax.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.0, 112.0, 169.0, 25.0 ],
					"text" : "durations in milliseconds"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 426.0, 172.0, 142.0, 40.0 ],
					"text" : "clear all the data stored in all inlets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 183.0, 53.0, 19.0 ],
					"text" : "clearall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 390.5, 147.5, 40.0, 19.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.5, 137.0, 152.0, 40.0 ],
					"text" : "clear the data stored in a specific inlet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 84.0, 127.0, 25.0 ],
					"text" : "bang to quantize!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 84.0, 84.0, 37.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 154.0, 65.0, 19.0 ],
					"text" : "(2 4) (60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 137.0, 173.0, 19.0 ],
					"text" : "(300 300 400 -200 320 320)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 164.0, 237.0, 19.0 ],
					"text" : "((6000 7000) 7200 8400 nil 6200 6300)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 14.0, 215.0, 439.0, 21.0 ],
					"text" : "bach.quantize separate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -90.0, 343.5, 99.0, 21.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Objects: bach.score, bach.quantize",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "objects"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Separate parameters quantization",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, separate, parameter, autoclear",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 609.0, 50.0 ],
					"text" : "Quantization is a more general operation, which could be performed not necessarily on some content directly coming from a bach.roll or a bach.score. By setting \"separate\" as argument, bach.quantize quantizes explicit parameters data: inlets and outlets behave exactly like bach.beatbox.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.027451, 0.14902, 0.768627, 0.47451 ],
