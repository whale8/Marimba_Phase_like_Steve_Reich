...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 53.0, 238.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 319.333344, 178.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 257.0, 368.833344, 204.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 427.0, 585.0, 36.0 ],
					"text" : "If you use letters A to G, the note is snapped to the \"nearest\" introduced letter (where \"nearest\" is meant with respect to the current cursor tick vertical position).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 265.333344, 162.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 433.0, 221.0, 142.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 114.0, 78.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 95.0, 239.0, 40.0 ],
					"text" : "Automatically jump to the next chord when a note is introduced"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 323.0, 114.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 142.0, 83.0, 19.0 ],
					"text" : "autojump $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 206.0, 452.0, 172.666672 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"text" : "Linear editing in bach.score (2)",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, mouse, keyboard, linear, speedy, fast, number, assign, existing",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 610.0, 79.0 ],
					"text" : "You can operate in linear editing mode also on an existing score, which you can then navigate via the keyboard arrows. If you navigate in linear editing mode via left/right arrows, you'll discover that the cursor can either be exactly on a given chord, or be in a blank position after a given chord, or a measure barline. In the first case, you can modify the existing chord. In the second case, you can input a new chord, or modify the previous one.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
