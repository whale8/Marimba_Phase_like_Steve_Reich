...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 322.0, 111.0, 54.0 ],
					"presentation_rect" : [ 220.0, 304.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 228.0, 595.0, 50.0 ],
					"presentation_rect" : [ 6.0, 240.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you end a syllable with a dash (\"-\") before pressing Tab, Shift+Tab or Esc, a dashed line will appear connecting the syllable to the next one. If next chord has no assigned lyircs, the dashed line will span till the next chord whose lyrics are assigned.",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 148.0, 384.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 207.0, 73.0, 241.0, 54.0 ],
					"presentation_rect" : [ 209.0, 68.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 436.0, 73.0, 163.0, 40.0 ],
					"presentation_rect" : [ 434.0, 68.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 416.0, 585.0, 50.0 ],
					"presentation_rect" : [ 6.0, 393.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Remember that, even if you're typing directly into the score, actually you're filling your linked slot content: lyrics and slot content always stay synchronized. Of course, you can also assign lyrics by open each note's corresponding slot window, and edit its content.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 175.0, 194.0, 25.0 ],
					"text" : "Slot 1 is defined as lyrics slot"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: slot+linkage, slot+linkage+lyrics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, interface, lyrics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 591.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If you have properly set a lyrics slot via the #slot+linkage system, you can directly edit lyrics inside your bach.roll or bach.score.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
