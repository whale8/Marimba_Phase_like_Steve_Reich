...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 473.285706, 320.5, 131.0, 25.0 ],
					"style" : "",
					"text" : "Select bottom line"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 322.5, 146.0, 22.0 ],
					"style" : "",
					"text" : "sel note if noteindex == 1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 319.0, 358.0, 281.0, 102.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.285706, 313.0, 156.0, 40.0 ],
					"style" : "",
					"text" : "Assign cents depending on velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.285706, 322.5, 160.0, 23.0 ],
					"style" : "",
					"text" : "loadmess sel all @defer 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 322.5, 124.0, 23.0 ],
					"style" : "",
					"text" : "cents = velocity ** 2"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 13.0, 358.0, 298.0, 102.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"velocityhandling" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 72.0, 599.285706, 239.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "- onset\n- duration\n- cents\n- velocity\n- tail\n- voice (which is the voice number)\n- noteindex (notes in chords are numbered bottom-up)\n- chordindex (chords are numbered left-to-right)\n- index (generic index of each element in its own sequence, e.g. index of a pitch breakpoint)\n\nFor bach.score only: \n- symonset  (symbolic onset in the measure)\n- symduration (symbolic duration)\n- symtail (sum of the previous two)\n- measure (measure number)\n- tie (1 if a tie starts, 2 if a tie ends, 3 if both, 0 otherwise)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 577.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When selecting via a #conditional+selection, and when operating on selection via #equations, you can use any of the following variables:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: conditional+selection",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Symbolic variables for expressions",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, selection, conditional, symbolic, expression, variable, equation, onset, duration, cents, velocity, tail, voice, index, symonset, symduration, symtail, measure, tie, noteindex, chordindex",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
