...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 454.916656, 334.0, 21.0 ],
					"presentation_rect" : [ 260.0, 447.5, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The \"breakpointshavevelocity\" attribute must be set to 1",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 323.0, 358.916656, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.0, 167.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 295.0, 199.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Breakpoint velocity is fully compatible with the bach.dl2line and bach.dl2curve abstractions",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 414.916656, 344.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 116.0, 367.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can choose with via #velocityhandling the way velocity should be shown. Notice how line segments change their color or size accordingly.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.5, 131.0, 199.0, 20.0 ],
					"text_width" : 103.5
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 263.5, 334.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You don't have the control on the enharmonicity, though.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.5, 202.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.5, 231.5, 185.0, 19.0 ],
					"text" : "breakpointshavenoteheads $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 209.5, 327.0, 54.0 ],
					"text" : "By default pitch breakpoints are diamond-shaped. You can decide to show them as notes by using the \"breakpointshavenoteheads\" attribute."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 225.0, 165.0, 367.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also inspect each breakpoint separately to set its velocity, as well as its pitch or position (see #inspector)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can control the pitch of each breakpoint, as well as its own velocity, provided that the \"breakpointshavevelocity\" attribute be set to 1.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 75.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 177.0, 75.0, 289.0, 40.0 ],
					"text" : "If the \"breakpointshavevelocity\" attribute is 1, each breakpoint can have its own velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 103.0, 167.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Breakpoint velocity and pitch",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 606.0, 19.0 ],
					"text" : "Tags: edit, editing, change, pitch, velocity, breakpoint, breakpointshavevelocity, velocityhandlin, breakpointshavenoteheads",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
