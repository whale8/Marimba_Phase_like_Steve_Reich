...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 390.0, 251.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Yet bach.wrap is not necessarily needed: see #single+measureinfo",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.5, 233.0, 161.0, 55.0 ],
					"text" : "this is the tempo value, in beats per minute (bpm)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.833328, 336.0, 195.0, 54.0 ],
					"text" : "Adding one level to wrap the measureinfo of the measure, and one level for the voice",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.833332, 353.0, 76.0, 20.0 ],
					"text" : "bach.wrap 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 6.0, 328.5, 63.833332, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.5, 316.0, 194.0, 55.0 ],
					"text" : "This means: a 4/4 measure, having 1/8 = 60 as tempo",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.25, 155.0, 274.5, 55.0 ],
					"text" : "This means: a 9/8 measure (a default tempo, or the last used tempo will be applied)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 134.0, 37.0, 19.0 ],
					"text" : "(9 8)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 362.0, 134.0, 33.0, 21.0 ],
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 134.0, 237.0, 21.0 ],
					"text" : "(ts_numerator ts_denominator)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 377.5, 234.0, 194.0, 55.0 ],
					"text" : "This means: a 4/4 measure, having quarter = 60 as tempo",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 113.0, 600.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In its simplest form, for each measure one has to define an llll containing:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 295.0, 404.0, 21.0 ],
					"text" : "(ts_numerator ts_denominator) (tempo_figure tempo)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 213.0, 299.0, 21.0 ],
					"text" : "(ts_numerator ts_denominator) (tempo)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.0, 295.0, 87.0, 19.0 ],
					"text" : "(4 4) (1/8 60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 433.0, 213.0, 65.0, 19.0 ],
					"text" : "(4 4) (60)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 444.0, 295.0, 33.0, 21.0 ],
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 213.0, 33.0, 21.0 ],
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 382.5, 288.0, 89.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: hierarchy, measureinfo+assignment",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, tempo, time, signature, bpm, beats, per, minute, value",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 600.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The Measureinfo is a special separate parameter specifying time signature and tempo information about each measure. It also might contain more information, such as barline types, measure width, and so on. The Measureinfo parameter is defined measure-wise, and can have different forms, in increasing order of complexity. In any case the first sublist in the llll represents the timesignature, and the second sublist represents the tempo.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 401.5, 323.75, 15.5, 323.75 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 442.5, 323.25, 15.5, 323.25 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 486.5, 323.25, 15.5, 323.25 ],
					"source" : [ "obj-43", 0 ]
				}
