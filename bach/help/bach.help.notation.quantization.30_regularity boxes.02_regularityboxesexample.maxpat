...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 88.0, 37.0, 270.0, 25.0 ],
					"presentation_rect" : [ 92.0, 30.0, 0.0, 0.0 ],
					"text" : "Click to quantize, and compare the results"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 438.0, 606.0, 36.0 ],
					"presentation_rect" : [ 6.0, 425.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If the number of regularity boxes information is less than the number of measure, the last choice will be repeated (so, just put (1/8) to have the whole voice quantized with 1/8-boxes)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 391.0, 132.0, 210.0, 98.0 ],
					"text" : "Here we say that we want the 1st measure measure to have two boxes: (1/4 3/4), and the 2nd measure to have the default boxes (which, for 4/4, have width = 1/4)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 142.0, 230.0, 84.0 ],
					"text" : "Here we say that we want the 1st measure measure to have boxes of width 1/8 and the 2nd measure to have boxes of width 2/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 389.0, 602.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Have a look at the difference at #quantize+box+example.As the boxes width decrease, finding the approximation within each box becomes easier and easier. Thus, even though the number of approximations to compute is larger, the performing time should be sensibly faster for small boxes.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 103.5, 183.0, 35.0, 21.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 508.0, 230.0, 85.0, 19.0 ],
					"text" : "((1/4 3/4) nil)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 230.0, 60.0, 19.0 ],
					"text" : "(1/8 2/4)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 247.116577, 291.0, 221.0, 92.0 ],
					"pitcheditrange" : "null",
					"simplifytuplets" : 0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.116577, 261.0, 279.883423, 21.0 ],
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 292.0, 221.0, 92.0 ],
					"pitcheditrange" : "null",
					"simplifytuplets" : 0,
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 42.0, 61.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 103.5, 68.0, 267.0, 90.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 261.0, 214.0, 21.0 ],
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: quantize+regularity+box",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "An example of regularity boxes usage",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, regularity, box, example",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
