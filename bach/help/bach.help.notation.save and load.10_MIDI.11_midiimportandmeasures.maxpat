...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 371.0, 300.5, 197.0, 36.0 ],
					"presentation_rect" : [ 24.0, 301.0, 0.0, 0.0 ],
					"showhand" : 0,
					"text" : "This is true by default; set (importbarlines 0) to disable it.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 206.0, 567.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "This is useful if you had exported \"bach barline\" markers via #MIDI+export and #exportbarlines specification. In this case, the position of the barline is independent from the time signature and tempo.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 338.5, 469.0, 21.0 ],
					"showhand" : 0,
					"text" : "In general, importbarlines and markmeasure should not be on at the same time.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 355.0, 244.5, 244.0, 54.0 ],
					"style" : "",
					"text" : "Open the specified MIDI file, putting barline markers wherever there was one saved barline"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 172.0, 559.0, 36.0 ],
					"showhand" : 0,
					"text" : "– importbarlines (default: 1): all the MIDI markers named \"bach barline\" are imported as barline markers. ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 262.0, 305.0, 23.0 ],
					"style" : "",
					"text" : "read goldberg3_barlinemodif.mid (importbarlines 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 175.0, 386.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 238.0, 119.5, 353.0, 40.0 ],
					"style" : "",
					"text" : "Open the specified MIDI file, marking all measures with barline markers, depending on time signature and tempo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 79.0, 567.0, 36.0 ],
					"showhand" : 0,
					"text" : "– markmeasures (default: 0): if non-0, a special \"barline\" marker will be added for each measure\n    in the MIDI file, according to the current time signature (especially useful for quantization)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 130.0, 232.0, 23.0 ],
					"style" : "",
					"text" : "read goldberg3.mid (markmeasures 1)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 360.666656, 585.0, 110.333344 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7850,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ -6.0, 24.0 ],
					"vzoom" : 100.0,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: marker+role, midi+quantize, export+midi, exportbarlines, midi+export",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "MIDI import and measure markers",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: data, read, midi, import, markmeasures, file, message, importbarlines, barline",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "When you import a MIDI file, it might be handy to have imported, as measure markers, all the measure barlines (also see #midi+quantize). This can be done in two ways:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
