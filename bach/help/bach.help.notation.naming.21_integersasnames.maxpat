...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 275.0, 45.0, 19.0 ],
					"text" : "sel 15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 97.0, 290.5, 37.0, 18.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.0, 452.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 273.5, 290.5, 155.0, 25.0 ],
					"text" : "...or a range of chords"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 272.0, 81.873047, 251.0, 69.0 ],
					"text" : "Have a look inside! The machine outputs the generated onset, pitch and an integer index, which we use as unique name for each chord"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 73.0, 211.0, 25.0 ],
					"text" : "Turn the generative machine on"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 50.0, 104.126953, 35.0, 21.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 294.0, 239.126953, 35.0, 21.0 ],
									"text" : "+ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 279.0, 213.126953, 35.0, 21.0 ],
									"text" : "int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 251.0, 163.126953, 167.0, 21.0 ],
									"text" : "expr \"random(6000, 8400)\""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 238.0, 135.126953, 50.0, 21.0 ],
									"text" : "t b b b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 63.5, 292.126953, 46.0, 19.0 ],
									"text" : "play 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 63.5, 265.126953, 68.0, 21.0 ],
									"text" : "delay 400"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 63.5, 175.126953, 69.0, 21.0 ],
									"text" : "t b clear 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 242.5, 265.126953, 59.0, 21.0 ],
									"text" : "pack f i i"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 50.0, 146.126953, 50.0, 21.0 ],
									"text" : "sel 0 1"
								}
...
,
									"patching_rect" : [ 138.916672, 226.126953, 72.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 238.0, 104.126953, 70.0, 21.0 ],
									"text" : "metro 100"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 58.5, 371.126953, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 242.5, 371.126953, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 303.5, 267.126953, 326.0, 267.126953, 326.0, 207.126953, 304.5, 207.126953 ],
									"source" : [ "obj-16", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 123.0, 203.626953, 304.5, 203.626953 ],
									"source" : [ "obj-73", 2 ]
								}
...
,
					"patching_rect" : [ 8.916672, 100.873047, 253.0, 27.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"text" : "p \"simple generative machine\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 137.0, 250.0, 226.0, 40.0 ],
					"text" : "Once we turn off the machine, we are able to select a given chord..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 427.0, 253.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 427.0, 275.0, 49.0, 21.0 ],
					"text" : "uzi 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 302.0, 81.0, 19.0 ],
					"text" : "sel index $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 253.0, 81.0, 19.0 ],
					"text" : "sel index 15"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 53.0, 174.0, 512.0, 69.0 ],
					"text" : "Since we want to label each chord with its index (representing the potision: 1st chord, 2nd chord...), we should definitely use integer number for this. Nothing prevents us, on the other hand, to give two names: the symbol \"index\" and then the integer index"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 443.488098, 452.0, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 8.916672, 73.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.916672, 157.0, 299.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 8.916672, 328.0, 526.0, 117.833336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: name, real-time, integer, unique",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Names can be either symbols or integers. If you need to give a lot of different names, using integer names is the best solution, so that you won't fill up Max symbol table.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
