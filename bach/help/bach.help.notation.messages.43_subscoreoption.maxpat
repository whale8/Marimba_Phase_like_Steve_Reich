...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 186.0, 236.0, 25.0 ],
					"presentation_rect" : [ 248.0, 189.0, 0.0, 0.0 ],
					"text" : "This dumps clefs, markers and body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 192.0, 245.0, 19.0 ],
					"presentation_rect" : [ 53.0, 192.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 349.0, 217.5, 253.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #body, #header and #dump+message",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 153.0, 239.0, 25.0 ],
					"text" : "This dumps key signatures and body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 156.0, 195.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.5, 119.0, 269.0, 25.0 ],
					"text" : "This dumps body (musical content) only"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.5, 122.0, 164.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.0, 68.5, 281.5, 40.0 ],
					"text" : "This dumps, additionally to the musical content, all header information (default)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 79.0, 124.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 459.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 359.5, 332.169708, 232.0, 118.666664 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 118.666664 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: subscore, body, header, dump+message",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Options for subscore extraction",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, subscore, extract, portion, score, option",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "As for the \"dump\" message, also for the \"subscore\" message you can explicitely decide what to dump via an optional last parameter.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 459.836365, 356.5, 459.836365, 356.5, 322.169708, 369.0, 322.169708 ],
					"source" : [ "obj-14", 0 ]
				}
