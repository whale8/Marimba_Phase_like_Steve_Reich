...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.5, 109.0, 152.0, 50.0 ],
					"presentation_rect" : [ 419.5, 109.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "There are other pages on #autobeam and #autorhythm.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.5, 172.0, 147.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "also see #autoparserhythm",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.5, 177.5, 279.0, 25.0 ],
					"style" : "",
					"text" : "Only perform rebeaming (without reparsing)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 179.5, 68.0, 23.0 ],
					"style" : "",
					"text" : "autobeam"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 426.0, 520.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "This is the most important rule while dealing with trees: don't you like current beamings? Select the portion of the score and press TAB, in order to have automatic beaming."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.5, 276.5, 277.0, 55.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.5, 220.5, 277.0, 69.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 129.0, 261.0, 40.0 ],
					"style" : "",
					"text" : "Reparse and rebeam automatically the selection, and also reparse all tuplets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 137.5, 86.0, 23.0 ],
					"style" : "",
					"text" : "autorhythm 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -297.0, 217.0, 157.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.5, 88.0, 312.0, 40.0 ],
					"style" : "",
					"text" : "Reparse and rebeam automatically the selection, but keep untouched the existing tuplets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 96.5, 76.0, 23.0 ],
					"style" : "",
					"text" : "autorhythm"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 22.0, 308.0, 505.0, 110.0 ],
					"pitcheditrange" : "null",
					"showrhythmictree" : 1,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 608.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The most important command handling the rhythmic representation is the rebeaming command.\nWhenever you see a portion of score whose beaming you don't like, you can always select it and rebeam it automatically, either via interface (just press Tab!) or via the \"autorhythm\" message.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Parsing and beaming automatically",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: rhythm, beam, auto, automatical, automatically, tab, rebeam, tuplet, keep, parse, autobeam, autorhythm, reparse, update",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
