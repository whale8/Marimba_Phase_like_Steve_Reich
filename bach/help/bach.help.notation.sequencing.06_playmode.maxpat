...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 224.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.5, 420.583344, 366.5, 40.0 ],
					"text" : "bach.ezmidiplay needs the Notewise playmode to handle ties and play/output MIDI information properly"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 404.0, 430.083344, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 359.083344, 379.0, 54.0 ],
					"text" : "When you play \"Notewise\", the information from the playout comes with a \"note\" symbol router, whereas when you play \"Chordwise\" the information comes with a \"chord\" router."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 139.0, 602.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Yet, sometimes, when a chord is played, one might need to more easily retrieve from the playout the entire chord gathered syntax. To do so, one should choose \"Chordwise\" as playmode.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.857147, 375.583344, 147.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -4.0, 185.583344, 78.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 194.583344, 133.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 149.0, 178.083344, 273.0, 54.0 ],
					"text" : "Choose the play mode, play a portion of score, and see the different messages coming from the playout"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 228.583344, 83.0, 19.0 ],
					"text" : "playmode $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "tttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 264.0, 540.0, 89.0 ],
					"pitcheditrange" : "null",
					"playoutfullpath" : 1,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "By default when you play a bach.roll or a bach.score, from the playout you get for each played note its gathered syntax (more or less: what you exactly get is the gathered syntax of a chord containing such note as a single note, ignoring thus all other notes in the chord: see #play+syntax). This correspond to the \"Notewise\" play mode: even if a chord is found during playing, what is output are its separate notes, one by one, with all the information they need. This comes handy in a lot of situations; for instance if you need to play each note with a synth, you might want to give directly such playout llll to a poly~ object.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, play, mode, notewise, chordwise, playmode",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
