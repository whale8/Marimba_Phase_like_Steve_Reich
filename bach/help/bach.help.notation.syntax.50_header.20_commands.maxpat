...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 445.0, 590.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Refer to the #command section of the help to know more about commands.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.0, 247.0, 360.0, 83.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 164.0, 593.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where the command number can be from 1 to 5, followed by two symbols: one which will be used to route the output notes, and one which will be used to route the output chords. Finally, you can define a hot key which will trigger the command when pressed after a selection has been made.\nYou just have to define the commands you need, and the order is irrelevant. On the other hand, when retrieved upon dump, all five commands are output, in ascending order.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 43.0, 140.0, 533.0, 21.0 ],
					"text" : "(<command_number> <symbol_for_note> <symbol_for_chord> <hotkey>)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 98.0, 487.0, 21.0 ],
					"text" : "(commands <COMMAND1_LLLL> <COMMAND2_LLLL> <COMMAND3_LLLL>...)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 119.0, 593.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each command llll define one of the five available commands. The syntax for each one of such lllls is:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 51.0, 593.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "A whole section of the documentation is reserved for commands (refer to #command to know what commands are for, and why they are useful). Here we just specify the syntax to represent them in the header of the notation object:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 257.0, 183.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 214.450012, 337.0, 336.0, 102.666664 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"out" : "ttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 337.0, 198.0, 102.666664 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: gathered+syntax+whole, syntax+header, command",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: header, syntax, command",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 593.0, 21.0 ],
					"showhand" : 0,
					"text" : "Commands are introduced by the command symbol.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
