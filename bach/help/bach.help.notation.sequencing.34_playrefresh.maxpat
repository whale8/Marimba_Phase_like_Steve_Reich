...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 109.25, 139.083344, 378.5, 40.0 ],
					"presentation_rect" : [ 117.0, 138.083344, 0.0, 0.0 ],
					"text" : "If you set the playstep to 0, the playhead is redrawn only when a new musical event is reached (note or marker)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 149.583344, 70.0, 19.0 ],
					"presentation_rect" : [ 38.0, 160.083344, 0.0, 0.0 ],
					"text" : "playstep 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 83.083351, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 115.083344, 75.0, 19.0 ],
					"text" : "playstep $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 52.083351, 85.0, 21.0 ],
					"text" : "loadmess 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 77.083351, 378.5, 54.0 ],
					"text" : "The playstep attribute represents the average plahead redraw time. You can increase it to have a smoother barline play, or decrease to reduce the redraw charge for the CPU"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 372.0, 590.0, 79.0 ],
					"presentation_rect" : [ 6.0, 399.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "N.B. The timing for all musical events (notes or markers) are not subjected to imprecision if you increase the playstep value. Even if you choose, say, 200ms as playstep, this does not mean in any way that all events will be more imprecise: indeed, this step is an indication for bach, which subdivides the time between each couple musical events into a certain number of steps (so that the distance between each couple of steps approximaticely matches the requested playstep).",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 428.625, 343.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 192.500015, 502.0, 139.833328 ],
					"pitcheditrange" : "null",
					"playstep" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 585.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The playhead is refreshed by default each 50ms. You can modify this refresh time by changing the \"playstep\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, play, playing, refresh, playhead, playbar, cursor, playstep, step, cpu, redraw",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
