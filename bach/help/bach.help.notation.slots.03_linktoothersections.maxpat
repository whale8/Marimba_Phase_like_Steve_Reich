...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 634.0, 188.0, 137.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 645.0, 159.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 302.5, 127.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 312.0, 327.0, 279.0, 111.0 ],
					"pitcheditrange" : "null",
					"slotwinzoom" : 150.0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.5, 181.083328, 168.0, 21.0 ],
					"text" : "loadmess slotwinzoom 200"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 397.5, 138.833344, 195.0, 116.166664 ],
					"pitcheditrange" : "null",
					"slotwinzoom" : 200.0,
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 273.0, 280.0, 108.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Refer to #slot+syntax to know the proper format in which slots can be assigned or retrieved via lllls. Although there is a common way to deal with slots (such as other extras) in #gathered or #separate+syntax, the slot content llll representation depends on the particular slot type (see #syntax+slot+content).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 133.0, 208.0, 137.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Refer to #slot+appearance to know about all the possibilities concerning slot appearance customization. For instance, you can keep some slots displayed in background, or you can change independently the zoom of the slot window and the zoom of the background slots.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 68.0, 585.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Refer to #slot+editing to have the complete list of the editing commands, organized by slot type, plus some interface combinations common to all slot types. For instance: double clicking on the slot name will open an editor for the slot content, or Cmd+doubleclick (mac) or Ctrl+doubleclick (win) on the slot name will clear the slot content.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Slot editing, appearance syntax and messages are treated in the Editing, Appearance, Syntax and Messages parts of the documentation.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 347.0, 23.0 ],
					"text" : "Slot editing, appearance, syntax, messages",
					"varname" : "title"
				}
