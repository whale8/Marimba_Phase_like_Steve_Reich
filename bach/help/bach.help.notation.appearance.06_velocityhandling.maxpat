...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.5, 313.0, 255.0, 40.0 ],
					"style" : "",
					"text" : "The same as \"Duration Line With\", but also involving sizes of noteheads"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.0, 151.0, 150.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.5, 335.0, 122.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 317.0, 160.0, 22.0 ],
					"style" : "",
					"text_width" : 116.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 161.0, 261.0, 361.0, 54.0 ],
					"style" : "",
					"text" : "Shows the different velocities by varying the width of the duration line, from a minimum (velocity = 1) to the defined \"durationslinewidth\" (velocity = 127)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.0, 219.0, 319.0, 40.0 ],
					"style" : "",
					"text" : "As the \"Color Gradient\", but varying transparency (alpha channel), and not color lightness"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.0, 176.0, 343.0, 40.0 ],
					"style" : "",
					"text" : "Map the velocity on a color spectrum ranging from red (velocity = 1) to violet (velocity = 127)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.5, 56.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 125.0, 97.0, 435.0, 54.0 ],
					"style" : "",
					"text" : "Show the velocity by varying the note color lightness, from white to the default color (by default this is black, so this yields a greyscale.) The default note color can be chosen via the \"notecolor\" attribute."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 72.0, 190.0, 25.0 ],
					"style" : "",
					"text" : "Don't show velocity (default)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.5, 89.0, 162.0, 239.0 ],
					"style" : "",
					"text" : "None\n\n\nColor Gradient\n\n\nColor Spectrum\n\n\nAlpha Channel\n\n\nDuration Line Width\n\n\nNotehead Size"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 17.5, 89.0, 18.0, 266.0 ],
					"size" : 6,
					"style" : "",
					"value" : 1
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 17.5, 362.0, 526.0, 104.833336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Objects: bach.score, bach.roll",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "objects"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: velocity, velocities, display, velocityhandling, notecolor, durationslinewidth, color, note, duration, line, width, alpha, spectrum, size, none",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 559.0, 36.0 ],
					"style" : "",
					"text" : "Both in bach.roll and in bach.score, the velocity of each note (a number from 1 to 127) can be mapped graphically in a certain number of ways, via the \"velocityhandling\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 434.5, 357.0, 27.0, 357.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 419.5, 357.0, 27.0, 357.0 ],
					"source" : [ "obj-19", 0 ]
				}
