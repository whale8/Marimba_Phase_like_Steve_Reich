...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 261.0, 194.5, 273.0, 25.0 ],
					"presentation_rect" : [ 278.0, 177.5, 0.0, 0.0 ],
					"text" : "Also for filter slots: don't need parentheses"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 197.5, 229.0, 19.0 ],
					"presentation_rect" : [ 47.0, 184.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 219.0, 318.0, 375.0, 40.0 ],
					"text" : "To simply make a given file active in a filelist slot, leave the position and the value to 0. This makes active the 2nd file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 328.5, 148.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.53064, 246.0, 347.0, 25.0 ],
					"text" : "\"active\" refers to the currently open slot window (if any!)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.53064, 277.5, 362.0, 40.0 ],
					"text" : "Append a filename in the 8th slot filelist. Last parameter is the index of the active file, 0 meaning: this value."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.5, 288.0, 190.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 355.0, 157.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.53064, 408.0, 90.0, 19.0 ],
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.03064, 408.0, 61.0, 19.0 ],
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 546.53064, 381.5, 60.0, 25.0 ],
					"text" : "(Test)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.03064, 384.5, 107.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.03064, 438.5, 153.969391, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.0, 123.5, 302.0, 40.0 ],
					"text" : "Use a zero position to append the element at the end of the already existing elements."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 134.0, 144.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 223.5, 295.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 220.5, 235.0, 25.0 ],
					"text" : "You can access slots via slot names"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 48.0, 248.0, 207.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 212.0, 156.5, 337.0, 40.0 ],
					"text" : "You can change also a single point in function slots: no parenthesis needed, just <x> <y> <slope>."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 167.0, 180.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 83.5, 313.0, 40.0 ],
					"text" : "Change the 2nd element of the 3rd slot (i.e. the 2nd number of the intlist slot) and set it to 13"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 94.0, 144.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 362.0, 423.0, 111.0 ],
					"pitcheditrange" : "null",
					"slotwinzoom" : 150.0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Setting single slot elements",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, operate, on, selection, slot, change, single, value, changeslotvalue",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
