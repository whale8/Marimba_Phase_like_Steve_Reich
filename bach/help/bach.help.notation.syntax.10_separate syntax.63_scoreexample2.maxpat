...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 54.0, 116.0, 25.0 ],
					"presentation_rect" : [ 255.0, 53.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.0, 137.0, 321.0, 21.0 ],
					"presentation_rect" : [ 313.0, 143.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #maketreecompatiblewithts, #breakrootlevelbeam",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 282.0, 92.0, 65.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 118.0, 305.0, 19.0 ],
					"presentation_rect" : [ 628.0, 117.0, 0.0, 0.0 ],
					"text" : "maketreecompatiblewithts 0, breakrootlevelbeam 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 274.0, 121.0, 55.0 ],
					"presentation_rect" : [ 389.5, 311.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 422.0, 249.0, 140.0, 21.0 ],
...
,
					"patching_rect" : [ 227.0, 249.0, 128.0, 21.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
,
					"patching_rect" : [ 32.0, 249.0, 175.0, 21.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -369.0, 64.0, 100.0, 21.0 ],
					"text" : "loadmess 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 174.0, 55.0, 53.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -137.0, 295.0, 99.0, 21.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 9.0, 323.0, 35.0, 21.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 218.0, 409.0, 21.0 ],
					"text" : "t i b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 9.0, 295.0, 298.5, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 194.0, 129.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 191.0, 238.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.900002, 165.0, 147.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.400002, 137.0, 122.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 32.0, 165.0, 62.400002, 21.0 ],
					"text" : "uzi 4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 9.0, 55.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 9.0, 82.0, 184.0, 21.0 ],
					"text" : "qmetro 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 32.0, 53.0, 116.0, 25.0 ],
					"text" : "turn qmetro on!"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 9.0, 110.0, 47.0, 21.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 9.0, 350.666687, 578.0, 114.333313 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 587.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "As an example, here we continuously build a bach.score, with random measures.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: separate+syntax, maketreecompatiblewithts, breakrootlevelbeam",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 321.0, 23.0 ],
					"text" : "Continuous bach.score generation",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: separate, syntax, example, build, generate, generation, continuous",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
