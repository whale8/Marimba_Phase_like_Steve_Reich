...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 324.0, 223.0, 137.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Although this is a selection cycle, it has the feedback feature in common with the standard bach lambda inlets and outlets behavior (that's why we used the \"lambda\" word to idenfity it). To know more, see #lambda+inlet. Especially, be careful not to put any delay or pipe in the middle of the cycle."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 422.0, 166.0, 177.0, 113.0 ],
					"text" : "A \"lambda\" message has no effect at all outside a selection cycle. \nIn order for it to work, it has to be cycled with elements being sent out the playout."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 139.5, 190.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.5, 342.0, 165.0, 21.0 ],
					"text" : "expr $i1 + random(-40\\, 40)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.75, 371.0, 161.0, 21.0 ],
					"text" : "if $i1 > 1000 then 1 else 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 232.041672, 404.0, 57.0, 21.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 232.0, 433.0, 383.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 243.0, 299.0, 246.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 305.0, 162.0, 21.0 ],
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 105.0, 383.0, 21.0 ],
					"text" : "whose arguments might depend on the note data being dumped.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 82.0, 205.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 82.0, 118.0, 19.0 ],
					"text" : "lambda velocity $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 82.0, 128.0, 19.0 ],
					"text" : "lambda eraseslot $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 189.0, 179.0, 21.0 ],
					"text" : "loadmess select all @defer 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 138.0, 94.0, 19.0 ],
					"text" : "dumpselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 106.5, 129.0, 247.0, 40.0 ],
					"text" : "Make a selection and send a \"dumpselection\" message, or press V"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 178.0, 403.0, 107.0 ],
					"pitcheditrange" : "null",
					"slotwinzoom" : 150.0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: dumpselection, message+change",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, operate, on, selection, lambda, operation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "All the standard operations to change selection parameters, breakpoints or slots support the lambda interaction mode. You are thus allowed to send lambda messages like:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 241.5, 470.0, 3.0, 470.0, 3.0, 173.0, 15.5, 173.0 ],
					"source" : [ "obj-7", 0 ]
				}
