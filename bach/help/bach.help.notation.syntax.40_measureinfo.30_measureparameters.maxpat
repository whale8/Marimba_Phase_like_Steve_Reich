...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 277.5, 278.0, 311.5, 69.0 ],
					"text" : "If you set measure parameters, the tempo specification must be always given. This will be tricky! (Look at the displayed tempo!) Give a \"nil\" or \"()\" tempo llll instead!",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 117.5, 293.5, 151.0, 19.0 ],
					"text" : "(((4 4) (width 80))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 244.0, 394.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #syntax+measure+widthfactor, #syntax+measure+barline, #syntax+measure+shownumber",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 134.0, 178.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #syntax+measure+width",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.0, 189.0, 421.0, 55.0 ],
					"text" : "This also create a second measure with hidden final barline, with no displayed measure number and with a given width factore",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 164.5, 500.0, 19.0 ],
					"text" : "(((4 4) (60) (width 100)) ((4 4) () (widthfactor 0.5) (barline h) (shownumber off))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.5, 115.0, 201.0, 40.0 ],
					"text" : "This creates one measure with a specific measure width",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.5, 125.5, 185.0, 19.0 ],
					"text" : "(((4 4) (60) (width 100))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 445.0, 575.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also assign measure parameters via the #setmeasureparameters message.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 132.0, 82.0, 291.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 319.0, 583.0, 116.571426 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ 4.571428, 28.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 504.0, 602.0, 31.0 ],
					"text" : "See Also: measureinfo, setmeasureparameters, syntax+measure+width, syntax+measure+widthfactor syntax+measure+barline, syntax+measure+shownumber",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 490.0, 602.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, measure, parameter",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 575.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Measureinfo is also used to assign specific measure parameters, specifying some particular properties of the measure, such as its width or its barline type. All these specifications must be introduced after the tempo specification, in the form",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
