...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 438.0, 290.0, 114.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 341.0, 422.0, 19.0 ],
					"text" : "((12 (2 4) ((80) (1/4 60 1/4))) (10 ((2 3 3) 16)) (3 (5 12) (1/12 80))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 228.5, 155.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 177.5, 231.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 17.0, 341.0, 32.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 316.0, 340.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 263.0, 109.0, 19.0 ],
					"text" : "((5 12) (1/12 80))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 338.0, 290.0, 84.0, 20.0 ],
					"text" : "bach.repeat 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.5, 263.0, 83.0, 19.0 ],
					"text" : "(((2 3 3) 16))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 263.0, 151.0, 19.0 ],
					"text" : "((2 4) ((80) (1/4 60 1/4)))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 177.5, 290.0, 91.0, 20.0 ],
					"text" : "bach.repeat 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 290.0, 91.0, 20.0 ],
					"text" : "bach.repeat 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 168.0, 499.0, 55.0 ],
					"text" : "We have prepended a \"4\" to the \"(2 4)\" time signature llll, meaning: the measureinfo that follows does not apply simply to a single measure, but to 4 measures on a row.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 84.0, 424.0, 21.0 ],
					"text" : "for_how_many_measures? TIME_SIGNATURE_LLLL TEMPO_LLLL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 146.0, 129.0, 25.0 ],
					"text" : "...you can do this!",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 149.0, 245.0, 19.0 ],
					"text" : "(((3 4) (60)) (4 (2 4)) ((4 4)) ((3 4))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 364.0, 111.0, 155.0, 25.0 ],
					"text" : "Instead of doing this...",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 114.0, 351.0, 19.0 ],
					"text" : "(((3 4) (60)) ((2 4)) ((2 4)) ((2 4)) ((2 4)) ((4 4)) ((3 4))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 374.0, 583.0, 97.571426 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ 4.571428, 9.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: measureinfo, time+signature+syntax, tempo+syntax",
...
, 			{
				"box" : 				{
					...
					"text" : "Measureinfo for more than one measure",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, more, than, one, measure, range, how, many",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 567.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You might want to keep the same measureinfo for more than one measure, you can define for how many measure a given measureinfo applies. In order to do so, just prepend an integer number before the time signature llll. In such a way the syntax becomes:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
