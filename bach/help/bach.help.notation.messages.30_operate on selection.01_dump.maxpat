...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 37.0, 220.0, 568.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "This works if you have properly defined commands in you bach.roll or bach.score. The result is exactly as if you pressed the associated command hotkey on the notation editor (see #command)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 158.5, 176.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "(but see #lambda+message)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.285713, 158.5, 88.0, 21.0 ],
					"style" : "",
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.285713, 158.5, 315.0, 21.0 ],
					"style" : "",
					"text" : "You can't rely on the order in which content is output."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 259.5, 157.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 268.0, 283.5, 90.0, 23.0 ],
					"style" : "",
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.469391, 283.5, 61.0, 23.0 ],
					"style" : "",
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.0, 280.5, 207.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.5, 283.5, 136.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.285713, 112.0, 577.714294, 50.0 ],
					"style" : "",
					"text" : "We call this off-line playing also \"dump\", but keep in mind that in fact it has the characteristics of a real play: content is played either chord-wise or note-wise (depending on the #playmode), and the lllls coming out from the playout are exactly as the one sent out while playing (see #play)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.0, 445.0, 215.0, 25.0 ],
					"style" : "",
					"text" : "Have a look at the Max window"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.0, 445.0, 150.0, 23.0 ],
					"style" : "",
					"text" : "bach.print PlayoutScore"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 304.0, 333.0, 298.0, 102.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.285721, 180.0, 348.0, 40.0 ],
					"style" : "",
					"text" : "Send a specific command (in this case, number 2) to all the currently selected notes or chords."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.285713, 190.5, 108.0, 23.0 ],
					"style" : "",
					"text" : "sendcommand 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.714279, 445.0, 137.0, 23.0 ],
					"style" : "",
					"text" : "bach.print PlayoutRoll"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.285714, 333.0, 289.0, 103.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.285713, 71.5, 354.0, 40.0 ],
					"style" : "",
					"text" : "Dump the selection, which means: \"play\" the selection in off-line mode from bach.roll's or bach.score's playout. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.285714, 82.0, 95.0, 23.0 ],
					"style" : "",
					"text" : "dumpselection"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: sel, select+all, clearselection, dump, play, playmode, command",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, dump, dumpselection, send, command, sendcommand",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Once you have selected musical content, either via mouse and keyboard, or via messages, you have a certain number of messages which are able to operate on such selection.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.785714, 326.0, 313.5, 326.0 ],
					"source" : [ "obj-59", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 33.785713, 326.75, 313.5, 326.75 ],
					"source" : [ "obj-60", 0 ]
				}
