...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 448.0, 63.0, 20.0 ],
					"presentation_rect" : [ 364.0, 456.0, 0.0, 0.0 ],
					"text" : "bach.print"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 448.0, 63.0, 20.0 ],
					"text" : "bach.print"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 280.0, 270.0, 54.0 ],
					"text" : "The commands llll is part of the object header, we can retrieve it upon dump, or upon specific \"dump command\" message"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 221.5, 300.0, 111.0, 19.0 ],
					"text" : "dump commands"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 257.0, 126.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 198.0, 544.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 147.0, 582.0, 51.0 ],
					"text" : "Commands are a part of the notation objects' header. To define them, send an llll in the form:\n(commands <CMD> <CMD> ... )\nwhere <CMD> = (<command_number> <symbol_for_note> <symbol_for_chord> <hotkey>)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 260.0, 275.0, 34.0 ],
					"text" : "(commands (1 granularnote granularchord g) (2 plainnote plainchord p))"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: command, define, assign",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
