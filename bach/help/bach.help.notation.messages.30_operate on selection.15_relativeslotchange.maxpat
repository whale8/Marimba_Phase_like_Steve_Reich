...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 224.0, 298.0, 375.0, 54.0 ],
					"presentation_rect" : [ 362.0, 308.0, 0.0, 0.0 ],
					"text" : "...or filter slots. Use \"nil\" to skip a parameter you don't want to change. Here we add 20Hz to the frequency, and remove 10dB to the gain. Filter type is left unchanged."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.25, 308.0, 154.5, 34.0 ],
					"presentation_rect" : [ 74.5, 307.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.5, 205.0, 516.0, 50.0 ],
					"text" : "In general, you can substitute any fixed value with a list of the type: (<parameter> <change_type>), where <change> type is one of the symbols: \"plus\", \"minus\", \"times\", \"div\" (you have to write them explicitly: you cannot use the operation symbols, ",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.03064, 259.5, 272.0, 40.0 ],
					"text" : "This also works for any other type of slot, as function slots..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.5, 262.0, 232.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 70.0, 590.0, 21.0 ],
					"text" : "Here we change the second element of third slot, according to the value it already had:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.5, 173.0, 210.0, 25.0 ],
					"text" : "divide the previous value by 2.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 56.5, 176.0, 178.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 146.0, 220.0, 25.0 ],
					"text" : "multiply the previous value by 2.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 149.0, 192.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 119.0, 231.0, 25.0 ],
					"text" : "subtract 13 from the previous value"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 122.0, 192.0, 19.0 ],
					"text" : "changeslotvalue 3 2 (13 minus)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 203.0, 91.0, 194.0, 25.0 ],
					"text" : "sum 13 to the previous value"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 94.0, 181.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 437.0, 348.0, 157.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.53064, 401.0, 90.0, 19.0 ],
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.03064, 401.0, 61.0, 19.0 ],
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 546.53064, 374.5, 60.0, 25.0 ],
					"text" : "(Test)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 434.03064, 377.5, 107.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.03064, 431.5, 153.969391, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 355.0, 423.0, 111.0 ],
					"pitcheditrange" : "null",
					"slotwinzoom" : 150.0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Modifying existing slot elements",
					"varname" : "title"
				}
