...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 295.0, 334.0, 185.0, 40.0 ],
					"text" : "All tempi, except for two of them, are redundant"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 334.0, 281.0, 34.0 ],
					"text" : "(((2 4) (60)) ((3 4) (60)) ((4 4) (60)) ((3 4) (60)) ((2 4) (70)) ((3 4) (70)) ((4 4) (70))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 393.0, 83.5, 185.0, 40.0 ],
					"text" : "We only define the tempo for the first measure"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 269.0, 114.0, 226.0, 55.0 ],
					"text" : "...or, equivalently, leave a \"nil\" or \"()\" list as tempo llll"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 114.0, 229.0, 69.0 ],
					"text" : "To avoid assigning a tempo to a measure, just give the time signature llll in the measureinfo..."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 378.833344, 596.0, 95.333336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 294.0, 586.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "However, you are totally allowed to define a tempo for each measure: if a given tempo will coincide with the previous one, it'll be accounted as redundant, and it will not be displayed.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 94.0, 380.0, 19.0 ],
					"text" : "(((2 4) (60)) ((3 4)) ((4 4)) ((3 4)) ((2 4)) ((3 4) ()) ((4 4) nil)), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 192.0, 596.0, 95.333336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: hierarchy, tempo+syntax, multiple+tempi",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 371.0, 23.0 ],
					"text" : "Redundant tempi",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, tempo, tempi, skip, skipping, redundant, assign, assignment",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "A tempo defined at one measure will be valid until a new tempo will be assigned. Thus you are not obliged to define a tempo for each measure: to measure which don't have one, the previous tempo applies.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
