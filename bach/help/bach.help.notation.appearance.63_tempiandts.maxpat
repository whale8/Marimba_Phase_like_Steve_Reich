...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.0, 89.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 209.0, 401.0, 50.0 ],
					"presentation_rect" : [ 208.0, 229.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Toggling the display of the time signatures also recomputes the spacing for all the score, so it is quite a heavy operation to perform, on big amount of data.",
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 79.0, 144.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 184.0, 141.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 114.0, 89.0, 19.0 ],
					"text" : "showtempi $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 20.0, 292.0, 501.0, 115.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 596.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Tempi and time signatures can be hidden by turning off the \"showtempi\" and \"showtimesignatures\" attributes.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tempi and time signatures",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, tempo, tempi, time, signature, show, hide, showtempi, showtimesignatures",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 205.0, 159.0, 148.0, 40.0 ],
					"presentation_rect" : [ 205.0, 193.0, 0.0, 0.0 ],
					"text" : "Toggle the display of all time signatures"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 89.0, 145.0, 40.0 ],
					"text" : "Toggle the display of all tempi"
				}
