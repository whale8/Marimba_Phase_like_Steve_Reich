...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 277.0, 157.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.5, 247.0, 410.0, 21.0 ],
					"text" : "If also works with list syntax (used for chords, assigned note by note):",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.530609, 266.5, 226.0, 54.0 ],
					"text" : "Transpose bottom chord note by 100mc, the one above by 200mc, the ones above by 300ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 107.5, 284.0, 226.0, 19.0 ],
					"text" : "cents (100 plus) (200 plus) (300 plus)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.5, 199.0, 507.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.5, 113.0, 297.0, 25.0 ],
					"text" : "Divide all the selected items' onsets by 1.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 113.0, 93.0, 19.0 ],
					"text" : "onset (1.1 div)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 174.0, 294.0, 25.0 ],
					"text" : "Transpose all selected notes 1 semitone down"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 177.0, 114.0, 19.0 ],
					"text" : "cents (100 minus)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 436.0, 82.0, 163.0, 50.0 ],
					"text" : "\"duration\", \"onset\" and \"tail\" messages only apply to bach.roll",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.530609, 331.5, 90.0, 19.0 ],
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.0, 331.5, 61.0, 19.0 ],
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 372.530609, 328.5, 207.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.030609, 331.5, 136.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.5, 144.0, 291.0, 25.0 ],
					"text" : "Increase all selected items' velocities by 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 147.0, 108.0, 19.0 ],
					"text" : "velocity (10 plus)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.5, 82.0, 297.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 86.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Modify existing parameter values",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 594.0, 31.0 ],
					"text" : "Tags: message, operate, on, selection, relative, change, onset, duration, tail, cents, velocity, modify, exist, existing, times, div, plus, minus, parameter",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "All the \"onset\", \"duration\", \"tail\", \"cents\" and \"velocity\" messages have another way to work. Instead of assigning a fixed value, you can assign a simple formula to tell how the existing values of such parameters have to be modified.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 56.5, 354.0, 313.214294, 354.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 93.5, 353.0, 313.214294, 353.0 ],
					"source" : [ "obj-5", 0 ]
				}
