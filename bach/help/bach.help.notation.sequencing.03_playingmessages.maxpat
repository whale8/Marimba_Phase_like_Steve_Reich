...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 437.0, 423.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When paused, the playhead cursor is updated to the last reached position while playing, so that a new play will by default start from there.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.5, 231.0, 109.0, 25.0 ],
					"text" : "Pause playing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.5, 234.0, 46.0, 19.0 ],
					"text" : "pause"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.5, 269.5, 95.0, 19.0 ],
					"text" : "play (1) (2 1/2)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 413.375, 259.0, 199.125, 40.0 ],
					"text" : "Play starting from measure 1, only until half of measure 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.5, 194.0, 326.5, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In bach.score you can also substitute the milliseconds position with the timepoint (see  #timepoint+syntax)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.5, 231.0, 76.0, 19.0 ],
					"text" : "play (2 1/4)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 228.0, 249.0, 25.0 ],
					"text" : "Play starting from measure 2, after 1/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 57.0, 194.0, 35.0, 19.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 191.0, 99.0, 25.0 ],
					"text" : "Stop playing"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 165.0, 99.0, 19.0 ],
					"text" : "play 2000 2500"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.0, 162.0, 373.0, 25.0 ],
					"text" : "Play only the portion of score between 2000ms and 2500ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 136.0, 67.0, 19.0 ],
					"text" : "play 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 95.0, 134.0, 179.0, 25.0 ],
					"text" : "Play starting from 2000ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 47.0, 80.0, 551.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The playhead cursor start position is by default at the beginning of the bach.roll or bach.score, so this message starts to play at the beginning. One can alter such cursor position either via mouse and keyboard (see #play+interface) or via message (see #cursor+message).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 446.5, 445.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 58.0, 34.0, 19.0 ],
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 299.0, 302.166687, 292.0, 129.833328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Some controls are available to help you play only the portion of the score you need.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 47.0, 55.0, 282.0, 25.0 ],
					"text" : "Play from the current playhead start position"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 309.666687, 283.0, 114.833328 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"velocityhandling" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, play, playing, stop, start, message, pause",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 294.083344, 308.5, 294.083344 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 293.083344, 308.5, 293.083344 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 45.5, 295.583344, 308.5, 295.583344 ],
					"source" : [ "obj-7", 0 ]
				}
