...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 259.5, 87.0, 19.0 ],
					"text" : "playselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 157.5, 62.0, 335.5, 40.0 ],
					"text" : "The selecting content will be played from its starting point, till the end of the last selected item"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 72.5, 87.0, 19.0 ],
					"text" : "playselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -348.5, 72.5, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -348.5, 110.666687, 283.0, 18.0 ],
					"text" : "sel note if \"random(0, 100) < 50\" && (onset > 1500)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.5, 102.0, 413.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #play+interface to know how to play the selection via the interface",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 382.428558, 443.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 21.0, 290.166687, 480.0, 134.833328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 585.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can play the selected content only by using the \"playselection\" message.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 65.0, 129.666687, 436.0, 113.833328 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"velocityhandling" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, play, playing, selection, playselection, message",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
