...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.5, 392.0, 238.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "All of this applies equally to bach.score.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 382.75, 326.0, 219.5, 40.0 ],
					"text" : "This is essential to change the extras without deleting content"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 29.0, 333.0, 208.0, 54.0 ],
					"text" : "Or, if you need an algorithmical way to do this, you can always send an explicit \"graphic\" llll"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 427.5, 368.0, 130.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 114.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.5, 339.0, 135.0, 21.0 ],
					"text" : "loadmess autoclear 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.5, 368.0, 179.0, 19.0 ],
					"text" : "(graphic (((5700 3/2)))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 392.0, 162.0, 21.0 ],
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 413.0, 607.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "User-defined accidentals are lost whenever interface actions are done on the pitches. For instance, if you shift the pitch up or down, or if you stretch the pitches altogether. Also, loosening the tone division sometimes leads to loss of user-defined accidentals (in which case you are notified with warnings in the Max window)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 316.0, 302.0, 119.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #popup+menu",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.0, 233.0, 415.0, 69.0 ],
					"text" : "If you right-click or perform a two-fingers tap on a notehead, a popup menu appears, and you will be able to choose the enharmonicity from a list of a few proposed ones"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 484.0, 254.0, 95.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #inspector",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0, 197.0, 415.0, 54.0 ],
					"text" : "If you open a note's inspector, you can set the pitch either as cents or as notename. If you set it as notename, you can of course choose the desired enharmonicity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.0, 170.0, 153.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #syntax+note+name",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 316.0, 101.0, 250.0, 69.0 ],
					"text" : "If you introduce music via messages, you can use notenames instead of midicents, which will be used to represent enharmonicity."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 128.0, 182.0, 19.0 ],
					"text" : "( B#3 (Db-4 do6) six+5), bang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 19.0, 164.0, 289.0, 90.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: graphic+syntax, syntax+note,name, inspector, popup+menu",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 188.0, 23.0 ],
					"text" : "User-defined accidentals",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 596.0, 19.0 ],
					"text" : "Tags: accidental, user, defined, userdefined, user-defined, graphic, enharmonic, enharmonicity, note, names, notenames",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 565.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The representation of a pitch (as a diatonic pitch plus an accidental) is named \"graphic\" specification (see #graphic+syntax). Such specification can be thus assigned to each note to set user-defined accidentals. Most of the time, there is no need to put the hands directly on the graphic syntax to set them, since you have a few different ways to modify the enharmonicities.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4.0, 350.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "4",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 442.0, 282.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 569.5, 120.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 587.0, 214.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
