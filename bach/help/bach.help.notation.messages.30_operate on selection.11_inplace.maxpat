...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.5, 233.0, 268.0, 19.0 ],
					"text" : "select all, cents = cents + 100, clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.714294, 293.0, 234.0, 25.0 ],
					"text" : "Take the square root of all velocities"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 271.5, 287.0, 19.0 ],
					"text" : "select all, velocity = sqrt(velocity), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 269.714294, 90.0, 248.0, 40.0 ],
					"text" : "Compress all the score by a factor of two"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 136.0, 393.0, 19.0 ],
					"text" : "select all, onset = onset / 2., duration = duration / 2., clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 177.0, 165.0, 222.0, 40.0 ],
					"text" : "Transpose everything a semitone up"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.5, 210.0, 248.0, 19.0 ],
					"text" : "select all, cents (100 plus), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: sel, select+all, clearselection, velocity, onset, duration, tail, cents, velocityhandling",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, operate, on, selection, in, place, inplace, in-place, transpose, transposition, compress, compression",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 590.0, 50.0 ],
					"text" : "The selection messages allows you to perform modification on existing data, without needing to dump and rebuild a new bach.roll or bach.score. Typically you might want to chain some selection messages with some operation messages, and then clear the selection.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
