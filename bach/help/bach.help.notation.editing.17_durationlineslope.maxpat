...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 324.0, 242.416672, 277.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 593.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each segment of durationline (between notehead and a pitch breakpoin, or between two breakpoints, or between a breakpoint and the note tail) can have a curve parameter (also see #breakpoint+curve+syntax). You can of course set it via the bach #inspector as the \"slope\" attribute, but you can also change it via the interface:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.0, 138.0, 273.0, 84.0 ],
					"text" : "Shift+Ctrl+click (mac) on a breakpoint and then drag up or down in order to change the slope of the portion of duration line preceeding the breakpoint",
					"textcolor" : [ 0.501961, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 198.5, 440.0, 127.833344 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: edit, editing, change, slope, duration, line, breakpoint",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
