...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 137.0, 113.0, 25.0 ],
					"presentation_rect" : [ 205.5, 140.0, 0.0, 0.0 ],
					"text" : "...and even lllls"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 142.0, 154.0, 19.0 ],
					"presentation_rect" : [ 83.5, 143.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 126.0, 81.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.5, 112.0, 185.0, 25.0 ],
					"text" : "Multiple names are allowed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.5, 115.0, 115.0, 19.0 ],
					"text" : "name paul george"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 340.0, 225.0, 229.0, 54.0 ],
					"text" : "A quick way to rename all markers as \"marker <number>\", where <number> is an unique number"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 235.0, 262.0, 34.0 ],
					"text" : "sel markers, name marker (incremental 1), clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 160.0, 326.0, 69.0 ],
					"text" : "Change the name of the selected markers to \"pippo\", but also make sure that those names are made unique by a second integer name, such as \"pippo 1\" or \"pippo 2\", and so on."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.5, 185.0, 169.0, 19.0 ],
					"text" : "name pippo (incremental 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 83.0, 329.0, 25.0 ],
					"text" : "Change the name of the selected markers to \"pippo\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 86.0, 79.0, 19.0 ],
					"text" : "name pippo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.5, 287.0, 135.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 296.5, 290.0, 91.0, 19.0 ],
					"text" : "clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 55.0, 266.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 58.0, 60.0, 19.0 ],
					"text" : "sel ringo"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: sel, unsel, select, name",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 173.0, 23.0 ],
					"text" : "Change marker names",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: marker, name, change, incremental",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 549.0, 21.0 ],
					"text" : "Once you have selected a marker, you can change easily its name(s).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 320.0, 287.5, 320.0 ],
					"source" : [ "obj-17", 0 ]
				}
