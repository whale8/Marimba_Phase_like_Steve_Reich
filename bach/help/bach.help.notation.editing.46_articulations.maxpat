...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 285.0, 258.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 316.333313, 218.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 662.0, 204.0, 72.0, 20.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.0, 97.0, 241.0, 84.0 ],
					"text" : "If the \"copyarticulationswithnotes\" attribute is active (by default it is not), when you copy a note, its articulations are copied as well"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 191.0, 181.0, 19.0 ],
					"text" : "copyarticulationswithnotes $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 375.0, 162.0, 21.0 ],
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 393.0, 589.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "bach supports most standard articulations, such as accents, portato, staccato, bowing, fermata, tremolo, trills and much more. Nonetheless not all the supported #notation+fonts have a glyph for all articulations. Especially Boulez only has a few articulation glyphs. If you don't see an articulation as you wish (e.g. tremoli with Boulez), it might be because the font doesn't have the proper character, so try to use another #notation+font, if you can."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.5, 245.0, 246.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 206.0, 218.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 165.0, 218.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 38.0, 231.0, 299.0, 128.333313 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: edit+articulation+list, notation+font",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: editing, edit, articulation, add, delete",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Articulations can be inserted by selecting the note(s) or chord(s) to which they should be attached, and pressing a given key combination. For instance, Alt+S will insert a \"staccato\" articulation, Alt+F will insert a fermata, and so on. The list of all possible commands can be found at #edit+articulations+list.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
