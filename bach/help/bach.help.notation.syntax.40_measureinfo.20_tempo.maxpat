...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 307.0, 322.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "Here's an example involving all this different syntaxes:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 519.0, 189.5, 88.0, 23.0 ],
					"style" : "",
					"text" : "(1/8 80 1/4 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 189.5, 33.0, 21.0 ],
					"style" : "",
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 206.0, 158.0, 84.0 ],
					"style" : "",
					"text" : "This is the symbolic duration to which the tempo is referred (the one at left of the \"=\" sign)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 429.0, 149.5, 171.0, 25.0 ],
					"style" : "",
					"text" : "Same, but with onset 1/4",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 153.0, 77.0, 23.0 ],
					"style" : "",
					"text" : "(1/8 80 1/4)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.0, 153.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 334.0, 206.0, 273.0, 113.0 ],
					"style" : "",
					"text" : "If you give a non-zero last parameter, this is interpreted as if a tempo interpolation starts with this tempo (and ends to the next one).\nA tempo interpolation is an accelerando or rallentando, depending if the next tempo is faster or slower than the current one",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.5, 206.0, 150.0, 84.0 ],
					"style" : "",
					"text" : "This is the symbolic onset of the position of the tempo inside the measure (default 0)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 121.0, 197.0, 25.0 ],
					"style" : "",
					"text" : "This represents 1/8 = 80 bpm",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 187.0, 479.0, 21.0 ],
					"style" : "",
					"text" : "(tempo_figure tempo onset_in_measure interpolation_to_next?)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 153.0, 299.0, 21.0 ],
					"style" : "",
					"text" : "(tempo_figure tempo onset_in_measure)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 333.0, 98.0, 25.0 ],
					"style" : "",
					"text" : "click to build",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 334.0, 423.0, 23.0 ],
					"style" : "",
					"text" : "(((4 4) (60)) ((2 4) (1/8 80 1/4)) ((3 4) (1/4 30 0 1)) ((3 4) (1/4 50))), bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 347.0, 124.0, 55.0, 23.0 ],
					"style" : "",
					"text" : "(1/8 80)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 317.0, 124.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 124.0, 167.0, 21.0 ],
					"style" : "",
					"text" : "(tempo_figure tempo)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 102.0, 596.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "But you can also define the tempo in one of the following syntaxes:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 79.0, 229.0, 25.0 ],
					"style" : "",
					"text" : "This represents quarter = 60 (bpm)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.0, 82.0, 34.0, 23.0 ],
					"style" : "",
					"text" : "(60)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 82.0, 33.0, 21.0 ],
					"style" : "",
					"text" : "e.g.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 82.0, 65.0, 21.0 ],
					"style" : "",
					"text" : "(tempo)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 369.0, 583.0, 103.333336 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ -0.857143, 5.428571 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -237.599976, 358.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: separate+syntax, hierarchy, measureinfo, autoclear",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: separate, syntax, measureinfo, tempo, figure, interpolation, accelerando, rallentando",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 578.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"style" : "",
					"text" : "The tempo is the second part of the #measureinfo. In its simplest form, it is just defined by an llll containing a single element: the tempo value (i.e. the beats per minute referred to the default 1/4 symbolic duration.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
