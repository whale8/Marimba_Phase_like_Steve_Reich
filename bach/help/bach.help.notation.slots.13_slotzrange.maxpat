...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -175.0, 168.0, 137.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ -175.0, 138.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 292.0, 260.0, 120.0 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 6.0, 293.5, 0.0, 0.0 ],
					"slotwinzoom" : 130.0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 76.5, 260.0, 120.0 ],
					"pitcheditrange" : "null",
					"slotwinzoom" : 130.0,
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 421.0, 162.0, 21.0 ],
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 289.5, 173.0, 25.0 ],
					"text" : "Increase or decrease this"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 226.0, 605.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also assign a \"zslope\" parameter in order to warp the display of the Z axis. As usual in Max, this slope can assume values from -1 to 1, 0 being linear (default). The slope only affects the displayed breakpoint function, not the slot data.",
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 355.5, 292.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.5, 319.0, 145.0, 19.0 ],
					"text" : "(slotinfo (1 (slope $1 )))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 198.5, 456.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Two numbers are expected: the Z range minimum and the Z range maximum.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 138.5, 144.0, 40.0 ],
					"text" : "...or via a slotinfo \"range\" specification"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.5, 149.0, 180.0, 19.0 ],
					"text" : "(slotinfo (1 (zrange -10 200)))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 435.0, 544.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Converting ranges can have dangerous effects on the slot content, see #slot+convert+range."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 175.5, 129.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 122.0, 144.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "In addition to domain and range, slots of type 3dfunction have a \"zrange\" specification, affecting the range of the values on the Z axis (the one \"coming out\" from the screen).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: slotinfo+inspector, slotinfo+syntax, llll+dollar, slot+convert+range",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: slot, slotinfo, zrange, zslope, range, slope",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.0, 99.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 570.0, 117.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
