...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -273.0, 319.166656, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 472.0, 185.5, 136.0, 79.0 ],
					"presentation_rect" : [ 477.0, 212.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "See #header to know more about all the header elements which can be preserved.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 185.5, 202.5, 40.0 ],
					"presentation_rect" : [ 222.0, 195.0, 0.0, 0.0 ],
					"text" : "Keep the body, but also the keys and the midichannels"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 159.0, 235.0, 25.0 ],
					"presentation_rect" : [ 180.0, 164.0, 0.0, 0.0 ],
					"text" : "Keep the body, but also the markers"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 142.0, 125.0, 21.0 ],
					"presentation_rect" : [ 225.0, 173.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #header, #body",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 126.0, 117.0, 373.0, 25.0 ],
					"presentation_rect" : [ 126.0, 121.0, 0.0, 0.0 ],
					"text" : "Keep no header elements, only the \"body\" (musical content)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 87.0, 89.0, 197.0, 25.0 ],
					"text" : "Keep all the header elements"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 120.0, 91.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.0, 196.0, 201.0, 19.0 ],
					"presentation_rect" : [ 58.0, 149.0, 0.0, 0.0 ],
					"text" : "quantize keys midichannels body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 6.0, 224.0, 121.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.0, 162.0, 142.0, 19.0 ],
					"presentation_rect" : [ 64.0, 123.0, 0.0, 0.0 ],
					"text" : "quantize markers body"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 92.0, 61.0, 19.0 ],
					"text" : "quantize"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 370.0, 513.5, 83.0 ],
					"pitcheditrange" : "null",
					"simplifytuplets" : 0,
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 308.0, 65.0, 19.0 ],
					"text" : "(2 4) (60)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 340.0, 224.0, 21.0 ],
					"text" : "bach.quantize"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: dump+message, header, body",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: quantize, quantization, select, header, selective, body",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "By default the \"quantize\" message outputs also all the header information, in order for it to be preserved in the resulting score. As for the #dump message, you can select via additional symbols which portion of the header (if any) has to be kept through the quantization.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
