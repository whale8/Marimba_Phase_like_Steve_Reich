...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 475.0, 275.0, 98.0, 25.0 ],
					"presentation_rect" : [ 54.0, 398.0, 0.0, 0.0 ],
					"text" : "Locked note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 538.0, 130.5, 78.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 347.0, 72.5, 176.0, 40.0 ],
					"text" : "Locking is only possible if \"allowlock\" is 1 (default)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 526.0, 71.5, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 526.0, 94.5, 82.0, 19.0 ],
					"text" : "allowlock $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 448.0, 507.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Lock color can be combined with solo and mute color: see #combine+lock+solo+mute.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 165.0, 350.0, 40.0 ],
					"text" : "Locked elements appear by default in a reddish color. You can change the lock color in the object inspector"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 175.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 311.0, 365.0, 212.0, 40.0 ],
					"text" : "Locked voice (hence all its chords)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 260.0, 91.0, 40.0 ],
					"text" : "Locked chord"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 350.0, 152.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Unlock the mute flag to the currently selected content"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Lock the currently selected content"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 292.0, 418.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 137.0, 48.0, 19.0 ],
					"text" : "unlock"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 108.0, 34.0, 19.0 ],
					"text" : "lock"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 82.0, 313.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can either lock/unlock content via messages...",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 608.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each notation items can be locked. Locked elements cannot be edited at all: they can't be changed or moved. For instance, you can't add breakpoints to a locked note, nor you can edit its slots.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: mute, solo, popup+menu",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: edit, editing, lock, unlock, locking",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 535.5, 254.25, 15.5, 254.25 ],
					"source" : [ "obj-21", 0 ]
				}
