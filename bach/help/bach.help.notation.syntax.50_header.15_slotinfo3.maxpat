...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 253.0, 232.0, 25.0 ],
					"text" : "Even if you set any of these fields..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 287.0, 406.0, 54.0 ],
					"text" : "...when the slotinfo is queried, these four fields are never retrieved. Only the necessary other fields are output (for instance: for function slots, no \"zrange\" specification is output, and so on)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 304.5, 89.0, 19.0 ],
					"text" : "dump slotinfo"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 446.0, 69.0, 21.0 ],
					"text" : "bach.print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 248.5, 227.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 22.0, 326.0, 526.0, 113.833336 ],
					"pitcheditrange" : "null",
					"popupmenuslots" : [ 1 ],
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 67.0, 606.0, 181.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "                        this should be set to 1 if one needs the slot to be constantly painted in the background (see #background+slots) or 0 otherwise. This information is constantly synchronized with the #bgslots \nattribute.\n               this should be set to 1 if one needs the slot to show up in the #note+popup+menu, or to 0 otherwise. This information is constantly synchronized with the #popupmenuslots attribute.\n                   this should be set to 1 if one wants that the right click (or two-fingers tap) on a note head directly pops up the slot window of the current slot, or to 0 otherwise. This information is constantly synchronized with the #rightclickslot attribute.\n             this field defines the possible #slot+linkage. Slot linkage is a way to entangle some notation or display features to the content of a given slot. You can specify here to which feature the slot should be linked, via one of the following symbols: \"none\", \"lyrics\", \"notecolor\", \"noteheadadjust\", \"noteheadchar\", \"noteheadfont\", \"notesize\". See #slot+linkage to know more.",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Some more fields can be set via the slotinfo. These fields are never retrieved when the slotinfo is queried via a dump message, since they correspond to attribute values.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 67.0, 596.0, 138.0 ],
					"showhand" : 0,
					"text" : "– background:\n\n\n– popup:\n\n– rightclick:\n\n\n– linkto:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: header, syntax, slotinfo, parameter, background, popup, right, click, rightclick, linkto",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 493.5, 255.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 582.0, 304.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
