...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.875, 298.5, 178.0, 40.0 ],
					"style" : "",
					"text" : "The same, but also paste copied tempi (default is 0)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 308.875, 307.0, 97.0, 23.0 ],
					"style" : "",
					"text" : "paste (tempi 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.875, 391.333344, 235.75, 79.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.625, 59.0, 339.875, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Two additional arguments provide the onset and starting voice number for pasting (use () or nil to skip one):",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 348.875, 263.0, 194.0, 40.0 ],
					"style" : "",
					"text" : "Paste copied/cut measures over the selected measures"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.625, 239.0, 160.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.0, 208.0, 171.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.125, 239.0, 34.0, 23.0 ],
					"style" : "",
					"text" : "cut"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 302.0, 271.0, 43.0, 23.0 ],
					"style" : "",
					"text" : "paste"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.25, 211.0, 39.0, 23.0 ],
					"style" : "",
					"text" : "copy"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 253.625, 345.0, 307.0, 120.333336 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 328.625, 166.0, 200.0, 40.0 ],
					"style" : "",
					"text" : "Paste selection at original position, starting at voice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.625, 176.5, 65.0, 23.0 ],
					"style" : "",
					"text" : "paste () 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.625, 96.5, 198.0, 25.0 ],
					"style" : "",
					"text" : "Paste selection at onset 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.625, 100.5, 76.0, 23.0 ],
					"style" : "",
					"text" : "paste 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 351.625, 123.5, 191.0, 40.0 ],
					"style" : "",
					"text" : "Paste selection at onset 1000, starting at voice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 96.125, 131.5, 116.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.875, 100.5, 103.0, 25.0 ],
					"style" : "",
					"text" : "Cut selection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.625, 67.5, 113.0, 25.0 ],
					"style" : "",
					"text" : "Copy selection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.125, 103.5, 34.0, 23.0 ],
					"style" : "",
					"text" : "cut"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.625, 135.5, 87.0, 23.0 ],
					"style" : "",
					"text" : "paste 1000 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.375, 134.5, 43.0, 23.0 ],
					"style" : "",
					"text" : "paste"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.875, 70.5, 39.0, 23.0 ],
					"style" : "",
					"text" : "copy"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can copy, cut and paste score content via messages both for bach.roll and bach.score",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: edit+copy, edit+cut, edit+paste",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, operate, on, selection, copy, cut, paste, score, content, tempi, tempo",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
