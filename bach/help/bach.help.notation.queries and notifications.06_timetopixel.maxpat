...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.0, 233.0, 345.0, 25.0 ],
					"style" : "",
					"text" : "Get the position in pixel of voice 2, measure 1, after 1/8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 205.0, 387.0, 25.0 ],
					"style" : "",
					"text" : "Get the position in pixel of the measure 1, after 1/8 (voice 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 138.0, 175.0, 392.0, 25.0 ],
					"style" : "",
					"text" : "Get the position in pixel of the beginning of measure 2 (voice 1)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 118.0, 458.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For bach.score, you can also use the usual #timepoint syntax:\n(<measure_number>) or (<measure_number> <sym_onset_in_measure>) or\n(<measure_number> <sym_onset_in_measure> <voice_number>) ",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 57.0, 53.0, 23.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 116.0, 97.0, 284.0, 21.0 ],
					"style" : "",
					"text" : "Answer is in the form: pixel <pixel_position>",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.0, 451.0, 138.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.380936, 451.0, 127.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 385.0, 424.5, 197.0, 23.0 ],
					"style" : "",
					"text" : "bach.keys pixel @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 13.380936, 424.5, 197.0, 23.0 ],
					"style" : "",
					"text" : "bach.keys pixel @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 295.0, 273.0, 313.0, 139.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.0, 57.0, 322.0, 40.0 ],
					"style" : "",
					"text" : "Get the position (in pixels, from the box left border) of a given onset (specified in milliseconds)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 273.0, 280.0, 139.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 86.0, 91.0, 23.0 ],
					"style" : "",
					"text" : "timetopixel $1"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: dumppixelpos, pixeltotime",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Converting time to pixels",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: query, queries, pixel, time, position, get, pixel, convert, conversion, timetopixel",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "You can easily convert a time position (in milliseconds, or a bach.score timepoint) in a pixel position.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 91.5, 266.5, 304.5, 266.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 267.0, 304.5, 267.0 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 64.880936, 266.5, 304.5, 266.5 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 42.880936, 266.5, 304.5, 266.5 ],
					"source" : [ "obj-46", 0 ]
				}
