...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 427.0, 362.083344, 183.5, 54.0 ],
					"text" : "...and Shift+V to dump the entire chords (if single notes were selected)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 436.5, 289.166687, 174.0, 69.0 ],
					"text" : "You can select anything and press V to dump the selection (i.e. play it offline)...",
					"textcolor" : [ 0.501961, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 240.083344, 231.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.5, 170.083344, 214.5, 94.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "What really happens when you pause sequencing is that the playhead cursor start point is updated to the pause position, so that at next play the cursor will start from there (see #show+cursor)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.5, 75.083351, 111.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #show+focus",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 281.5, 445.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 21.0, 289.166687, 480.0, 134.833328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "All the following interface commands work both for bach.roll and for bach.score",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 95.666687, 380.0, 113.833328 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"velocityhandling" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, play, playing, interface, selection, pause, start, stop",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
