...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 451.0, 155.0, 79.0, 20.0 ],
					"text" : "loadmess 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 117.0, 147.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 283.0, 117.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.0, 145.0, 103.0, 19.0 ],
					"text" : "lyricsfontsize $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 304.5, 282.5, 280.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The second and third option are the most common ones, the second (corresponding to number 2) is the default.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 337.0, 255.0, 72.0, 20.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 434.0, 152.0, 40.0 ],
					"text" : "This is a word extension"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 38.0, 186.5, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Word extensions are the bottom straight lines extending a given syllable under the following notes, if these are not assigned any lyrics",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 56.0, 207.0, 25.0 ],
					"text" : "Toggle word extensions display"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.5, 201.0, 316.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Currently the \"Auto\" alignment (default) coincides with the \"Center\" alignment, but this might be improved in future versions.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 56.0, 143.0, 25.0 ],
					"text" : "Toggle lyrics display"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -237.0, 79.0, 78.0, 21.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 196.0, 59.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 84.0, 180.0, 19.0 ],
					"text" : "showlyricswordextensions $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 85.0, 90.0, 19.0 ],
					"text" : "showlyrics $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 238.5, 125.0, 54.0 ],
					"text" : "Do lyrics affect spacing? (for bach.score only)"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-19",
					"items" : [ "Never", ",", "Only", "Inside", "Each", "Measure", ",", "They", "May", "Also", "Stretch", "Measure", "Width", "Only", "If", "They", "Risk", "To", "Overlap", ",", "They", "Always", "Affect", "Also", "Measure", "Width" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 162.5, 255.0, 428.5, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.5, 284.5, 136.0, 19.0 ],
					"text" : "lyricsaffectspacing $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.0, 176.0, 166.0, 25.0 ],
					"text" : "Change lyrics alignment"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-15",
					"items" : [ "Auto", ",", "Left", ",", "Center", ",", "Right" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 137.0, 180.0, 100.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 137.0, 206.0, 116.0, 19.0 ],
					"text" : "lyricsalignment $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 115.0, 172.0, 40.0 ],
					"text" : "Adjust the lyrics baseline vertical position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -115.0, 177.0, 90.0, 21.0 ],
					"text" : "loadmess -16"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 26.0, 117.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.0, 145.0, 83.0, 19.0 ],
					"text" : "lyricsvadj $1"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 335.0, 525.0, 134.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Some attributes help you dealing with graphical display of lyrics.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: slot+linkage, slotinfo+inspector, lyrics+interface",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 591.0, 31.0 ],
					"text" : "Tags: appearance, lyrics, attribute, show, showlyrics, adjust, baseline, position, base, line lyricsvadj, word, extension, showlyricswordextensions, affect, spacing, lyricsaffectspacing, lyricsfontsize",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 205.5, 107.5, 15.5, 107.5 ],
					"source" : [ "obj-25", 0 ]
				}
