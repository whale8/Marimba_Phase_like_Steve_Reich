...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 193.0, 402.0, 406.0, 65.0 ],
					"presentation_rect" : [ 345.0, 330.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If extras are attached to chords, and not to notes (such it can be the case for articulations), the extra llll must be placed in the equivalent position in the chord gathered syntax llll (right before the chord flag). See #syntax+articulation to have some examples.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 270.0, 254.0, 50.0 ],
					"presentation_rect" : [ 353.0, 277.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The order of the extras llll is irrelevant, as long as they are placed at the end of the note llll (but before the note flag, if any)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 369.0, 179.0, 98.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 270.0, 332.0, 55.0 ],
					"text" : "For instance, this message adds a note having some pitch breakpoints, and some slot content"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 327.0, 312.0, 34.0 ],
					"text" : "addchord 1 (0 (6000 1000 100 (breakpoints (0 0 0) (0.5 800 0.8) (1 460 -0.5)) (slots (3 10 20 30))))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 212.0, 602.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where \"name\" is the symbol identifying the extra (such as \"breakpoints\" or \"slots\"), and \"content\" is the specific syntax of the given extra. Refer to #syntax+breakpoint, #syntax+slot, #syntax+graphic, #syntax+name, #syntax+articulation to know more about each specific syntax.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 191.0, 611.0, 21.0 ],
					"text" : "(<name> <CONTENT_LLLL>)",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 171.0, 393.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Each llll containing the extras is in the syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 150.0, 611.0, 21.0 ],
					"text" : "(<cents> <velocity> <start_a_tie?> <EXTRA1_LLLL> <EXTRA2_LLLL>... <opt:flag>)",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 131.0, 97.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For bach.score",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 110.0, 611.0, 21.0 ],
					"text" : "(<cents> <duration_ms> <velocity> <EXTRA1_LLLL> <EXTRA2_LLLL>... <opt:flag>)",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: separate+syntax+extra, syntax+breakpoint, syntax+slot, syntax+graphic, syntax+name, syntax+articulation",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: gathered, syntax, extra",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 593.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Extras are defined in the gathered syntax by assigning specific lllls inside the attached-element syntax, before the note flag (or at the end, if no note flag is given). Since most extras are note-attached, the common gathered syntax to define a given extra for a given note alters the #note+gathered+syntax in the following way.\nFor bach.roll:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
