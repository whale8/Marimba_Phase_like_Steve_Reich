...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.5, 167.5, 584.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.5, 213.0, 492.0, 36.0 ],
					"text" : "Answer is routed by \"voicepixelpos\", and for each voice it returns an llll containing:\n(<y_pixel_middleC> <y_pixel_bottom_staffline> <y-pixel_top_staffline>)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 188.0, 249.0, 25.0 ],
					"text" : "Retrieve vertical position of each voice"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 190.0, 107.0, 19.0 ],
					"text" : "getvoicepixelpos"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.5, 122.0, 591.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.0, 447.0, 137.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.380936, 447.0, 126.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 413.0, 401.5, 191.0, 36.0 ],
					"text" : "bach.keys dumppixelpos voicepixelpos @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.5, 75.0, 594.0, 50.0 ],
					"text" : "The message outputs a list with all the pixel information for each chord. The list is formatted as all the separate syntax lists coming from the separate outputs: a list for each voice (containing for bach.score a list for each measure) containing a list for each chord. This latter contains:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "bang" ],
					"patching_rect" : [ 13.380936, 401.5, 204.0, 36.0 ],
					"text" : "bach.keys dumppixelpos voicepixelpos @keep 1 @out t"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 295.0, 256.0, 313.0, 134.083328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 103.0, 51.0, 295.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 256.0, 280.0, 133.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 55.0, 91.0, 19.0 ],
					"text" : "dumppixelpos"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: pixel+time+conversion",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: query, queries, pixel, position, dump, dumppixelpos, getvoicepixelpos, get, voice, voicepixelpos",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "The position on the screen of each voice and of each chord and note can be retrieved.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 250.5, 304.5, 250.5 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 28.5, 249.0, 304.5, 249.0 ],
					"source" : [ "obj-7", 0 ]
				}
