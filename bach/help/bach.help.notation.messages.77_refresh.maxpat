...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 84.0, 580.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Since all messages and editing combinations properly refresh the object canvas automatically, you should in principle never need the \"redraw\" message, except for the very special cases where the canvas refresh depends on some action being performed on some other object (see #custom+spacing+relative for an example).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 116.0, 161.0, 161.0, 25.0 ],
					"style" : "",
					"text" : "Rather useless, per se!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 161.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "refresh"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 65.0, 347.0, 526.0, 120.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 10.0, 212.0, 356.0, 123.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7830,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: custom+spacing+relative",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: message, redraw, repaint, paint, draw, force, compute, recomputation, refresh",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "You can always force the redraw of a notation object by sending a \"refresh\" message, which will also force the recomputation of all volatile parameters (such as spacing, notes and accidental positioning, scrollbar position, and so on).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
