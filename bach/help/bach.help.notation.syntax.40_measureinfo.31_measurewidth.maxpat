...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 289.0, 287.0, 240.0, 54.0 ],
					"text" : "This makes the spacing slightly more compressed than the default one (compression factor is 0.8).",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 340.0, 404.214294, 96.0, 21.0 ],
					"presentation_rect" : [ 149.0, 416.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 379.0, 238.0, 25.0 ],
					"presentation_rect" : [ 293.0, 412.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 234.0, 263.0, 280.0, 25.0 ],
					"presentation_rect" : [ 312.0, 245.0, 0.0, 0.0 ],
					"text" : "This reverts to the automatic measure width",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 266.0, 189.0, 19.0 ],
					"presentation_rect" : [ 44.0, 283.5, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 85.0, 188.0, 487.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The measure barline is not locked (see #measure+width+factor)",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.5, 342.0, 234.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 142.0, 566.0, 51.0 ],
					"showhand" : 0,
					"text" : "– widthfactor: expects as value a multiplier factor, which will be locally applied to the measure \n                      spacing, and which will compress (for values less than 1) or expand (for values \n                      greater than 1) the width of the measure and the spacing of its chords accordingly.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.0, 80.0, 536.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "fixed \"width\" parameter will also lock the measure ending barline (see #barline+lock), so that the width will remain the same, no matter how many chords and notes the measure does and will contain. You can set, on the other hand, the symbol \"auto\" instead of a fiexed with, to revert to the default situation, where the measure width depends on its content.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 49.0, 571.0, 36.0 ],
					"showhand" : 0,
					"text" : "– width: expects as value a fixed width in pixels that the measure will have (referred to the default\n             vertical and horizontal zoom of 100%, and modified accordingly to those). Assigning a",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 73.0, 304.5, 214.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 209.0, 336.0, 54.0 ],
					"text" : "This creates one measure with a width of 90 pixels (for horizontal and vertical zoom of 100%), no matter how many notes are inside the measure",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 227.5, 178.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -427.0, 321.0, 91.0, 20.0 ],
					"text" : "loadmess clear"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 365.428589, 334.0, 106.571426 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")" ],
					"voicespacing" : [ 4.571428, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: measureinfo, measure+parameter, zoom, vzoom, measure+width+lock, autoclear",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, measure, parameter, width, widthfactor, auto",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 575.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Two measure parameters handle the measure width:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 533.0, 304.5, 20.0, 20.0 ],
					"presentation_rect" : [ 578.0, 299.0, 0.0, 0.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 530.0, 220.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 518.0, 265.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 338.25, 173.0, 338.25 ],
					"source" : [ "obj-7", 0 ]
				}
