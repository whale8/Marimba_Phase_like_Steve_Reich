...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 428.0, 207.0, 40.0 ],
					"style" : "",
					"text" : "We select the note being played and add 100 cents to it"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 298.0, 354.0, 105.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.5, 393.0, 212.0, 25.0 ],
					"style" : "",
					"text" : "Address of currently played note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.5, 143.0, 35.0, 23.0 ],
					"style" : "",
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.5, 88.916656, 78.0, 23.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.5, 117.416656, 20.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.5, 143.0, 112.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.5, 396.0, 53.0, 23.0 ],
					"style" : "",
					"text" : "2 3 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 381.0, 119.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 444.0, 354.0, 141.0, 23.0 ],
					"style" : "",
					"text" : "bach.keys note @out t"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 428.0, 165.0, 38.0 ],
					"style" : "",
					"text" : "sel note $1 $2 $3, cents = cents + 100, clearselection"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 28.5, 176.5, 504.0, 160.0 ],
					"pitcheditrange" : "null",
					"playoutfullpath" : 1,
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 263.0, 81.0, 258.0, 69.0 ],
					"style" : "",
					"text" : "Play this example different times: as you see, it is easy to retrieve the address and change the note's features"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Retrieving the full path from the playout syntax can be crucial to achieve certain live interface configurations. It makes very easy, indeed, to select the played note or chord (via #sel+note or #sel+chord) and modify it on the fly.",
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: sel+note, sel+chord, playout+syntax, cents+message, clearselection",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Usage of full path in playout syntax",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Tags: sequencer, sequencing, play, full, path, playout, example, usage, playoutfullpath",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 453.5, 471.0, 15.0, 471.0, 15.0, 167.0, 38.0, 167.0 ],
					"source" : [ "obj-30", 0 ]
				}
