...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.5, 150.0, 156.0, 40.0 ],
					"text" : "Timepoint syntax also works for bach.score"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.5, 161.0, 79.0, 18.0 ],
					"text" : "interp (1 1/4)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 125.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 453.0, 349.0, 137.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "tttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 299.0, 203.333313, 291.0, 137.666672 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 377.5, 606.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Output syntax is:  interp <VOICE1> <VOICE2>..., where each <VOICE> is (<CHORD1> <CHORD2>...), and where each <CHORD> is simply (<NOTE1> <NOTE2>...).\nEach note is in the #note+gathered+syntax, with two important exceptions: there is no duration or tie element, and each #temporal+slot is only output with its unique sampled element at the given position (e.g. the interpolated function point of a function slot).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.428574, 349.0, 126.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -168.0, 262.0, 118.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "ttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 203.333313, 282.0, 133.333328 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7700,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 81.5, 125.0, 212.0, 54.0 ],
					"text" : "Obtain whole information about notes being played at the introduced position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 155.0, 61.0, 19.0 ],
					"text" : "interp $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: getcurrentchord, interp+slot, note+gathered+syntax, temporal+slot",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Retrieving notes at a generic instant",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: message, interp, get, chord, note, position, instant, interpolate, generic, moment",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 33.0, 585.0, 79.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "To retrieve the complete information about the notes being played at a given position in the score, you should use the \"interp\" command which works similarly to the #interp+slot command.\nTime point is given as argument (for bach.score, also see #timepoint+syntax.\nDifferently from #getcurrentchord, the #interp message also output the slots at the sampled point, and keeps the hierarchical representation of voices, chords and notes.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
