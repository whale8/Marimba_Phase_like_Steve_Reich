...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 358.0, 242.0, 226.0, 55.0 ],
					"presentation_rect" : [ 227.25, 267.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Decaying of accidental validity can be set in milliseconds (0 = no decay)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 356.0, 328.0, 162.0, 21.0 ],
					"style" : "",
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.25, 251.0, 114.0, 21.0 ],
					"presentation_rect" : [ 355.0, 269.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For bach.roll only:",
...
, 			{
				"box" : 				{
					"attr" : "accidentaldecay",
					"id" : "obj-21",
					"maxclass" : "attrui",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 358.0, 295.5, 182.0, 22.0 ],
					"style" : "",
					"text_width" : 124.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.0, 345.0, 257.0, 123.0 ],
					"presentation_rect" : [ 290.0, 310.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For bach.roll, the \"Altered Notes\" and \"Altered Notes (No Repetitions)\" configuration can sensibly slow down the object usage in realtime, especially if accidentaldecay is set to 0 (or very large). Use any other configuration if you need good real-time performances (bach.score does not suffer from this drawback).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 386.0, 348.0, 78.0 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 76.75, 79.0, 396.5, 25.0 ],
					"style" : "",
					"text" : "Display accidentals on every single note (natural notes included)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2.0, 61.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 68.25, 208.0, 340.0, 25.0 ],
					"style" : "",
					"text" : "Never display any accidental (i.e.: hide all accidentals)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 172.0, 393.0, 40.0 ],
					"style" : "",
					"text" : "As \"Altered Notes\" but naturals are never displayed. In such a way, all non-natural notes (and only them) have accidentals."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 209.75, 135.0, 333.0, 40.0 ],
					"style" : "",
					"text" : "As \"Altered Notes\", but accidentals are dropped for sequences where the same note is repeated."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.75, 101.0, 396.5, 40.0 ],
					"style" : "",
					"text" : "Accidentals are always displayed, for any note who has one. Naturals are only displayed for the first note needing them."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.0, 212.0, 204.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Also see #cautionary+accidentals",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 133.75, 29.0, 451.25, 54.0 ],
					"style" : "",
					"text" : "Default display of accidentals: for bach.score, if an accidental is shown, all the following identical notes inside the same measure don't display the accidental; for bach.roll, it coincides with \"Altered Notes\" (No Naturals)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 24.0, 55.0, 197.0, 166.0 ],
					"style" : "",
					"text" : "Classical (default)\n\nAlways\n\nAltered Notes\n\nAltered Notes (No Repetitions)\n\nAltered Notes (No Naturals)\n\nNever"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 57.0, 18.0, 176.0 ],
					"size" : 6,
					"style" : "",
					"value" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 237.0, 191.0, 23.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 295.0, 348.0, 87.0 ],
					"pitcheditrange" : "null",
					"showaccidentalspreferences" : 1,
					"spacingwidth" : 1.2,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "See Also: cautionary+accidental",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 237.0, 23.0 ],
					"style" : "",
					"text" : "Accidental display policy",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 476.0, 601.0, 31.0 ],
					"style" : "",
					"text" : "Tags: accidental, repeat, hide, repeating, hiding, show, preference, showaccidentalspreferences, alter, altered, repetition, natural, never, always, classical, show, preference, policy",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
