...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 33.0, 50.0, 21.0 ],
					"presentation_rect" : [ 6.0, 83.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 291.0, 353.0, 69.0 ],
					"text" : "A panoramic of different barlines for different measures. Notice that the last two coincide (since the automatic barline for an ending measure is an ending barline).",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.5, 253.0, 526.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 72.0, 376.0, 54.0 ],
					"text" : "The automatic barline is the default barline. It coincides with the \"final\" barline for ending measures, and with \"normal\" barline for any other measure",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.5, 444.0, 504.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also change the barline type via the popup menu: see #popup+barline",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.5, 73.0, 194.0, 138.0 ],
					"showhand" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 218.0, 353.0, 25.0 ],
					"text" : "Creates one measure with hidden ending barline",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 221.0, 180.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 338.428589, 583.0, 103.571426 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: measureinfo, measure+parameter, zoom, vzoom, measure+width+lock",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: syntax, measureinfo, measure, parameter, barline, type",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 32.0, 455.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The             parameter assigns a specific ending barline to a given measure. \nIt expects a specific letter, representing the barline type.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
