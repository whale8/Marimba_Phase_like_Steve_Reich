...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 100.0, 556.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If the #marker+role requires a content, this is appended after the <role> (see #marker+content)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.5, 261.0, 235.0, 21.0 ],
					"text" : "If no marker is found, nothing is output.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.5, 211.0, 290.0, 50.0 ],
					"text" : "If you query a single marker, the name is always first, so you'll have an answer in the form: marker <name(s)> position_ms role",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.75, 416.5, 283.0, 54.0 ],
					"text" : "Even if bach.score doesn't support marker roles, the \"role\" element is kept in the output (as \"none\") for future compatibility"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 309.5, 52.0, 288.5, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "If a marker has just one name, its name is output as a single atom. Otherwise, #names are output as a wrapped list of atoms.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 433.0, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 433.0, 94.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 282.0, 266.0, 139.0 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 278.0, 282.0, 325.0, 140.5 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 222.0, 185.0, 282.0, 25.0 ],
					"text" : "same with two names (\"ringo\" and \"george\")"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 66.0, 188.0, 146.0, 19.0 ],
					"text" : "getmarker ringo george"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.5, 156.0, 326.0, 25.0 ],
					"text" : "get a single marker: the (first) marker named \"ringo\""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.0, 125.0, 353.0, 25.0 ],
					"text" : "as the previous one, but name and position are reversed"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 56.0, 222.0, 40.0 ],
					"text" : "get all the markers as a list of (<position_ms> <name> <role>)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 128.0, 147.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 159.0, 102.0, 19.0 ],
					"text" : "getmarker ringo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 66.5, 70.0, 19.0 ],
					"text" : "getmarker"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: query, marker+role, marker+content",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 8.0, 139.0, 23.0 ],
					"text" : "Querying markers",
					"varname" : "title"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: marker, getmarker, namefirst, query, retrieve, search",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "One can easily retrieve information about all markers or about a specific marker.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 41.5, 272.5, 287.5, 272.5 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 15.5, 272.25, 287.5, 272.25 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 75.5, 272.5, 287.5, 272.5 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 63.5, 272.0, 287.5, 272.0 ],
					"source" : [ "obj-8", 0 ]
				}
