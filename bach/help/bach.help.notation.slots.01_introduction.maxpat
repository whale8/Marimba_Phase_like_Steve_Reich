...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 375.0, 606.0, 36.0 ],
					"presentation_rect" : [ 6.0, 404.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "You can also assign slots via messages (see #slot+message) or add them to the gathered or separate syntax. The proper slot syntax to be used is carefully explained in #slot+syntax.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 111.0, 602.0, 79.0 ],
					"presentation_rect" : [ 6.0, 87.0, 0.0, 0.0 ],
					"text" : "Each one of the 30 slots has its own independent type, describing the kind of information contained inside it. Such information can have different forms: functions, numbers, lists, matrices, text, lllls, files, filters, and more. The type of each one of the 30 slots is global: if you change it, it'll change for all notes inside the score. On the other hand, of course, the slot content for each note is local: when you edit it, it only affects the note to which it is linked.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 411.0, 602.0, 65.0 ],
					"presentation_rect" : [ 6.0, 348.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "To assign all global characteristics of slots (e.g.: the type, or the hot keys, or much more) you need to define or change the #slotinfo: the global information regarding slot features. In order to do so, you can either access it via the inspector (open the #inspector when a slot window is open; also see #inspector+slotinfo), or via message (see #syntax+slotinfo).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 254.0, 156.0, 55.0 ],
					"presentation_rect" : [ 214.0, 193.0, 0.0, 0.0 ],
					"text" : "This is an open slot window for a certain note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 425.0, 245.0, 189.0, 69.0 ],
					"text" : "This is bach.slot, a handy floating slot window, which can be useful in many situations!"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -152.0, 288.0, 137.0, 18.0 ],
					"text" : "select all, openslotwin 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 190.0, 606.0, 65.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The simplest way to edit slot content is via the slot window interface. Select a note, and press a key from 1 to 9 to open the corresponding slot. You can access slot 10 via the key 0, and you can access any other slot by assigning a #slot+hotkey. All the editing commands, for each type of slot, are carefully explained in #slot+interface.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 514.0, 608.0, 19.0 ],
					"text" : "See Also: slot, slot+hotkey, slot+interface, slot+message, slot+syntax, slotinfo, inspector, inspector+slotinfo, syntax+slotinfo",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 607.0, 79.0 ],
					"text" : "Each note in bach.roll and bach.score has 30 free slots, where you can store additional meta-information regarding the note. This is very handy, since it turns bach.roll and bach.score into two powerful sequencers, whose meta-data is note-attached. You can thus easily store any amplitude envelopes, spectral envelopes, number of partials, filters, routing matrices, list of samples to be played, spatialization curves, and much more.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
