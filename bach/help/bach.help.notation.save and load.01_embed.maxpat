...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 425.0, 578.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "In a safe line of work, you are more than encouraged to explicitly save the content of your notation object via the #write and #read messages, and/or via #preset support. Embedding data with the patcher should not be considered a safe way to save important data: keep backups elsewhere!",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 407.0, 162.0, 21.0 ],
					"text" : "IMPORTANT:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.0, 69.5, 177.0, 83.0 ],
					"text" : "By default the content of bach.score, bach.roll and bach.slot is saved within the patch. If you don't want this, turn this off!"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 63.0, 274.0, 271.0, 124.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 15.0, 164.0, 382.0, 99.0 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7100,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 108.0, 69.0, 19.0 ],
					"text" : "embed $1"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: write, read, preset",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: data, embed, save, data, with, patch, patcher",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 32.0, 552.0, 36.0 ],
					"text" : "You can automatically save the content of your bach.roll, bach.score or bach.slot with your patch via the \"embed\" attribute.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
