...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 210.0, 127.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "This corresponds to all the notes being played at once",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 217.0, 452.5, 129.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "see #playout+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 368.0, 416.0, 104.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 242.0, 34.0, 19.0 ],
					"text" : "play"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 399.5, 345.0, 54.0 ],
					"text" : "The played content is output from the playout, in a flavour of the gathered syntax form, named \"playout syntax\", immediately recognizable by bach.ezmidiplay"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.0, 141.0, 180.0, 98.0 ],
					"text" : "Or you can really play the bach.roll or bach.score, i.e. sequence musical content in real-time, either by using the message \"play\"/\"stop\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.0, 231.0, 95.0, 19.0 ],
					"text" : "dumpselection"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 105.0, 585.0, 21.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "Technically, two ways of \"playing\" data are available:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 308.0, 275.0, 283.0, 114.833328 ],
					"pitcheditrange" : "null",
					"playpartialnotes" : 0,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"sendto" : "bach.help.filtertags",
					"text" : "Both bach.roll and bach.score have a special outlet (the one-but-last one), named the \"playout\" or \"play outlet\", reserved for outputting data concerning notes or chords currently being played.\nMoreover, such outlet is used also to output various types of notifications, such as domain changes, or loop activation, and much more (see #notifications).",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 141.0, 296.0, 84.0 ],
					"text" : "You can use an \"offline\" play of the musical data, named \"selection dump\", which you can achieve, once you have performed a selection, either by sending a \"dumpselection\" message..."
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnt",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 275.0, 292.0, 114.833328 ],
					"pitcheditrange" : "null",
					...
					"versionnumber" : 7200,
					"voicenames" : [ "(", ")", "(", ")" ],
					"voicespacing" : [ -9.6, 12.8, 4.400001 ],
					"vzoom" : 90.909088,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: playmode, playout+syntax",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: sequencer, sequencing, play, playing, playout, off, line, off-line, offline",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 388.0, 141.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 308.0, 141.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
					"textovercolor" : [ 0.2, 0.2, 0.2, 1.0 ]
