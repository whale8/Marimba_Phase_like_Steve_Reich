...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 203.0, 169.5, 392.0, 25.0 ],
					"presentation_rect" : [ 206.0, 161.0, 0.0, 0.0 ],
					"text" : "Always show all ledger lines between main and auxiliary staves"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 79.0, 90.0, 166.0, 25.0 ],
					"presentation_rect" : [ 213.0, 92.0, 0.0, 0.0 ],
					"text" : "Never show ledger lines"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -189.0, 104.0, 72.0, 20.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 91.0, 121.0, 506.0, 40.0 ],
					"presentation_rect" : [ 280.0, 122.5, 0.0, 0.0 ],
					"text" : "Only show ledger lines which are really needed to understand note positioning (i.e. hide ledger lines between main and auxiliary staves if not needed)"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 298.0, 279.0, 299.0, 184.821777 ],
					"pitcheditrange" : "null",
					"presentation_rect" : [ 0.0, 0.0, 0.0, 157.333328 ],
					"spacingtype" : 1,
					"spacingwidth" : 1.9,
					"stafflines" : 5,
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 279.0, 292.0, 184.821777 ],
					"pitcheditrange" : "null",
					"stafflines" : 5,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"tonedivision" : 4,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 226.0, 122.0, 19.0 ],
					"text" : "showledgerlines $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 171.0, 169.0, 21.0 ],
					"text" : "Always refer to main staves"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 130.5, 63.0, 21.0 ],
					"text" : "Standard"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.0, 92.0, 45.0, 21.0 ],
					"text" : "Never"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 6.0, 92.0, 18.0, 122.0 ],
					"size" : 3,
					"value" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 590.0, 50.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "When you use the staff combinations involving auxiliary staves (see #clef), you can decide whether the ledger lines should be shown or hidden between the main staves and the additional staves. You can also decide to hide all ledger lines.",
...
, 			{
				"box" : 				{
					...
					"text" : "Tags: appearance, ledger, line, ledgerlines, auxiliary, main, staff, staves, show, hide, showledgerlines",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "tags"
				}
