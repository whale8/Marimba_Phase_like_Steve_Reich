...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 248.0, 40.625, 208.0, 23.0 ],
									"style" : "",
									"text" : "loadmess bach.quantize @defer 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 10.0, 69.0, 924.0, 476.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 309.898438, 10.0, 91.0, 23.0 ],
									"style" : "",
									"text" : "Help Center"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "bach.quantize" ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 296.049927, 57.567627 ]
								}
...
,
					"patching_rect" : [ 10.0, 121.0, 164.0, 20.0 ],
...
,
					"style" : "",
					"text" : "p \"Quantization Help Center\"",
					"varname" : "basic_tab[5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 205.0, 169.0, 20.0 ],
					"saved_object_attributes" : 					{
...
,
					"style" : "",
					"text" : "js helpstarter.js bach.quantize"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 653.0, 282.0, 109.0, 38.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 287.0, 160.0, 187.0, 25.0 ],
									"style" : "",
									"text" : "Send a \"quantize\" message",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 75.0, 197.0, 134.0, 69.0 ],
									"style" : "",
									"text" : "Give the desired measureinfo in the first inlet.",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 252.75, 313.0, 259.0, 40.0 ],
									"style" : "",
									"text" : "Link the outlet of bach.roll to the second inlet of bach.quantize.",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ -90.0, 344.0, 88.0, 19.0 ],
									"style" : "",
									"text" : "loadmess clear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 10.0, 306.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"out" : "nnnnnnnn",
									"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
									"patching_rect" : [ 32.0, 387.0, 514.0, 134.0 ],
									"pitcheditrange" : "null",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 32.0, 271.0, 65.0, 23.0 ],
									"style" : "",
									"text" : "(2 4) (60)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 32.0, 338.0, 224.0, 23.0 ],
									"style" : "",
									"text" : "bach.quantize"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 588.0, 210.0, 263.0, 65.0 ],
									"style" : "",
									"text" : "If you don't wan't polyphonic behaviours, consider using  bach.mono first. \nIf you additionally don't want any rest, you might consider sending",
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"ignoreclick" : 1,
									"jsarguments" : [ "bach.quantize", 110 ],
									"maxclass" : "jsui",
									"numinlets" : 1,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 10.0, 10.0, 667.0, 126.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 49.0, 210.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "3",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 480.0, 163.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 515.0, 323.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"style" : "",
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 225.0, 188.0, 41.5, 188.0 ],
									"source" : [ "obj-26", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 303.898438, 53.625 ]
				}
...
, 			{
				"name" : "bach.help.notation.quantization.13_quantization from markers.05_midiimport.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/bach/help",
				"type" : "JSON",
				"implicit" : 1
			}
