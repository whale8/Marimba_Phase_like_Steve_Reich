...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 411.5, 287.5, 174.0, 40.0 ],
					"text" : "Timepoint syntax is accepted by bach.score"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.0, 298.0, 240.0, 19.0 ],
					"presentation_rect" : [ 209.0, 299.0, 0.0, 0.0 ],
					"text" : "(markers (1000 belushi) ((2 1/4) simon))"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 436.0, 590.0, 36.0 ],
					"presentation_rect" : [ 55.0, 289.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The existing markers are deleted as soon as you enter the new ones. If you don't want this, consider using the #addmarker message.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 247.0, 380.0, 40.0 ],
					"presentation_rect" : [ 324.0, 234.0, 0.0, 0.0 ],
					"text" : "Multiple names for markers are wrapped in a level of parentheses. Marker roles are only supported by bach.roll"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 200.0, 284.0, 21.0 ],
					"presentation_rect" : [ 34.0, 219.0, 0.0, 0.0 ],
					"text" : "(<TIMEPOINT_LLLL> <marker_name(s)>)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 164.0, 564.0, 36.0 ],
					"presentation_rect" : [ 6.0, 184.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "The marker roles are supported only by bach.roll (see #marker+roles for more information).\nFor bach.score measure-attached markers, the marker llll has the following syntax:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 221.0, 564.0, 21.0 ],
					"presentation_rect" : [ 6.0, 183.0, 0.0, 0.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "where the timepoint llll is in the syntax explained in #timepoint+syntax.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 143.0, 533.0, 21.0 ],
					"presentation_rect" : [ 75.0, 152.0, 0.0, 0.0 ],
					"text" : "(<position_ms> <marker_name(s)> <optional:role> <optional:content>)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 87.0, 455.0, 21.0 ],
					"text" : "(markers <MARKER1_LLLL> <MARKER2_LLLL> <MARKER3_LLLL>...)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 108.0, 564.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "For bach.roll markers, or bach.score milliseconds-attached markers (see #marker+attach) the marker llll has the following syntax:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 51.0, 586.0, 36.0 ],
					"sendto" : "bach.help.filtertags",
					"text" : "A whole section of the documentation is reserved for markers (refer to #marker). Here we just specify the syntax for markers represented as a header llll:",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 250.0, 221.0, 34.0 ],
					"text" : "(markers (1000 nydepp) (2000 aner) (3000 (ringo george) barline))"
				}
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 214.450012, 333.0, 247.0, 104.333328 ],
					"pitcheditrange" : "null",
...
, 			{
				"box" : 				{
					...
					"out" : "ttttttt",
					"outlettype" : [ "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 6.0, 333.0, 198.0, 102.666664 ],
					"pitcheditrange" : "null",
					"stafflines" : [ 5, 5 ],
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"versionnumber" : 7200,
...
, 			{
				"box" : 				{
					...
					"text" : "See Also: gathered+syntax+whole, syntax+header, marker, marker+attach, timepoint+syntax, marker+role, marker+content",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"varname" : "seealso"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 6.0, 31.0, 586.0, 21.0 ],
					"showhand" : 0,
					"text" : "Marker are introduced by the marker symbol, and are all defined in the header of the notation object.",
					"textcolor" : [ 0.5, 0.5, 0.5, 1.0 ],
					"underline" : 0
				}
