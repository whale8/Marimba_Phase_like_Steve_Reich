...
,
					"patching_rect" : [ 69.625, 264.957458, 148.0, 29.0 ],
...
,
					"patching_rect" : [ 240.0, 282.0, 82.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 150.0, 446.0, 32.5, 20.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 652.0, 111.0, 91.0, 18.0 ],
					"text" : "repeatmode $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 422.5, 306.0, 32.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 5.0, 140.0, 71.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 150.0, 477.0, 32.5, 20.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 446.0, 111.0, 32.5, 20.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "bang" ],
					"patching_rect" : [ 8.0, 73.0, 394.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 520.0, 80.0, 283.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 105.0, 646.0, 391.0, 20.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 612.0, 149.0, 20.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 669.0, 54.0, 20.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 477.0, 695.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 188.0, 34.0, 18.0 ],
					"text" : "$1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 647.0, 512.0, 125.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 647.0, 548.0, 105.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "bang", "", "", "", "", "" ],
					"patching_rect" : [ 7.0, 40.0, 532.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 522.0, 133.0, 0.0, 0.0 ]
								}
...
,
					"patching_rect" : [ 443.0, 473.0, 103.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 559.0, 191.0, 20.0 ],
					"text" : "if $i2 == 10 then 10 else $i1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 322.0, 534.0, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 200.0, 494.0, 141.0, 33.0 ],
					"text" : "if $i1 < 10 then $i1 else out2 $i1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 446.0, 135.0, 230.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 503.0, 282.0, 46.0, 20.0 ],
					"text" : "t i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 468.0, 149.0, 20.0 ],
					"text" : "expr $i3%$i2 + ($i1-1)*$i2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 422.5, 274.0, 32.5, 20.0 ],
					"text" : "/"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 463.0, 408.0, 32.5, 20.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 385.0, 41.0, 20.0 ],
					"text" : "round"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 443.0, 436.0, 53.0, 20.0 ],
					"text" : "zl group"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 463.0, 361.0, 101.0, 20.0 ],
					"text" : "expr $i1*200./$i3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "int" ],
					"patching_rect" : [ 436.0, 332.0, 46.0, 20.0 ],
					"text" : "uzi 2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 503.0, 234.0, 32.5, 20.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 546.0, 211.0, 59.0, 20.0 ],
					"text" : "bach.gcd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 503.0, 188.0, 37.0, 20.0 ],
					"text" : "!/ 15."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 446.0, 163.0, 162.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 70.0, 588.0, 149.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 501.0, 99.0, 20.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 70.0, 700.0, 149.0, 20.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 69.625, 122.0, 340.5, 20.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 324.3, 65.0, 536.5, 65.0 ],
					"source" : [ "obj-7", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 324.3, 67.0, 815.0, 67.0, 815.0, 692.0, 79.5, 692.0 ],
					"source" : [ "obj-7", 3 ]
				}
